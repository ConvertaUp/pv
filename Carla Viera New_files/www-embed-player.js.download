...
function ya(a){for(;a.h.h;)try{var b=a.i(a.h);if(b)return a.h.o=!1,{value:b.value,done:!1}}catch(c){a.h.m=void 0,ra(a.h,c)}a.h.o=!1;if(a.h.j){b=a.h.j;a.h.j=null;if(b.Ya)throw b.za;return{value:b["return"],done:!0}}return{value:void 0,done:!0}}
...
c.prototype=b.prototype;a.H=b.prototype;a.prototype=new c;a.prototype.constructor=a;a.zk=function(d,e,f){for(var g=Array(arguments.length-2),h=2;h<arguments.length;h++)g[h-2]=arguments[h];return b.prototype[e].apply(d,g)}}
...
m=Ob.prototype;m.qa=!0;m.ma=function(){return this.i};
...
function Ec(a,b){fb(b,function(c,d){c&&"object"==typeof c&&c.W&&(c=c.V());"style"==d?a.style.cssText=c:"class"==d?a.className=c:"for"==d?a.htmlFor=c:Fc.hasOwnProperty(d)?a.setAttribute(Fc[d],c):0==d.lastIndexOf("aria-",0)||0==d.lastIndexOf("data-",0)?a.setAttribute(d,c):a[d]=c})}
...
return a}
var Lc={Db:"allow-forms",Eb:"allow-modals",Fb:"allow-orientation-lock",Gb:"allow-pointer-lock",Hb:"allow-popups",Ib:"allow-popups-to-escape-sandbox",Jb:"allow-presentation",Kb:"allow-same-origin",Lb:"allow-scripts",Mb:"allow-top-navigation",Nb:"allow-top-navigation-by-user-activation"},Nc=Xa(function(){return Mc()});
...
b;return a}
function id(a,b){b||(b={});b[kd(a)]=!0;var c=a.stack||"",d=a.Ak;d&&!b[kd(d)]&&(c+="\nCaused by: ",d.stack&&0==d.stack.indexOf(d.toString())||(c+="string"===typeof d?d:d.message+"\n"),c+=id(d,b));return c}
...
m.set=function(a,b,c){var d=!1;if("object"===typeof c){var e=c.Ik;d=c.secure||!1;var f=c.domain||void 0;var g=c.path||void 0;var h=c.Aa}if(/[;=\s]/.test(a))throw Error('Invalid cookie name "'+a+'"');if(/[;\r\n]/.test(b))throw Error('Invalid cookie value "'+b+'"');void 0===h&&(h=-1);this.h.cookie=a+"="+b+(f?";domain="+f:"")+(g?";path="+g:"")+(0>h?"":0==h?";expires="+(new Date(1970,1,1)).toUTCString():";expires="+(new Date(Date.now()+1E3*h)).toUTCString())+(d?";secure":"")+(null!=e?";samesite="+e:"")};
...
function b(p){for(var q=g,r=0;64>r;r+=4)q[r/4]=p[r]<<24|p[r+1]<<16|p[r+2]<<8|p[r+3];for(r=16;80>r;r++)p=q[r-3]^q[r-8]^q[r-14]^q[r-16],q[r]=(p<<1|p>>>31)&4294967295;p=e[0];var z=e[1],A=e[2],D=e[3],da=e[4];for(r=0;80>r;r++){if(40>r)if(20>r){var va=D^z&(A^D);var oc=1518500249}else va=z^A^D,oc=1859775393;else 60>r?(va=z&A|D&(z|A),oc=2400959708):(va=z^A^D,oc=3395469782);va=((p<<5|p>>>27)&4294967295)+va+da+oc+q[r]&4294967295;da=D;D=A;A=(z<<30|z>>>2)&4294967295;z=p;p=va}e[0]=e[0]+p&4294967295;e[1]=e[1]+
...
function sd(a){var b=pd();b.update(a);return b.Ka().toLowerCase()}
...
if("undefined"!==typeof a&&!J("Trident")&&!J("MSIE")){var b=new a,c={},d=c;b.port1.onmessage=function(){if(void 0!==c.next){c=c.next;var e=c.wa;c.wa=null;e()}};
return function(e){d.next={wa:e};d=d.next;b.port2.postMessage(0)}}return function(e){w.setTimeout(e,0)}}
...
ee.prototype.preventDefault=function(){ee.H.preventDefault.call(this);var a=this.i;a.preventDefault?a.preventDefault():a.returnValue=!1};var ge="closure_listenable_"+(1E6*Math.random()|0);var he=0;function ie(a,b,c,d,e){this.listener=a;this.h=null;this.src=b;this.type=c;this.capture=!!d;this.ia=e;this.key=++he;this.Y=this.ga=!1}
function je(a){a.Y=!0;a.listener=null;a.h=null;a.src=null;a.ia=null}
;function ke(a){this.src=a;this.listeners={};this.h=0}
ke.prototype.add=function(a,b,c,d,e){var f=a.toString();a=this.listeners[f];a||(a=this.listeners[f]=[],this.h++);var g=le(a,b,d,e);-1<g?(b=a[g],c||(b.ga=!1)):(b=new ie(b,this.src,f,!!d,e),b.ga=c,a.push(b));return b};
...
function le(a,b,c,d){for(var e=0;e<a.length;++e){var f=a[e];if(!f.Y&&f.listener==b&&f.capture==!!c&&f.ia==d)return e}return-1}
...
function Ae(a){if("number"!==typeof a&&a&&!a.Y){var b=a.src;if(b&&b[ge])me(b.h,a);else{var c=a.type,d=a.h;b.removeEventListener?b.removeEventListener(c,d,a.capture):b.detachEvent?b.detachEvent(xe(c),d):b.addListener&&b.removeListener&&b.removeListener(d);pe--;(c=ve(b))?(me(c,a),0==c.h&&(c.src=null,b[ne]=null)):je(a)}}}
function xe(a){return a in oe?oe[a]:oe[a]="on"+a}
function ye(a,b){if(a.Y)var c=!0;else{c=new ee(b,this);var d=a.listener,e=a.ia||a.src;a.ga&&Ae(a);c=d.call(e,c)}return c}
...
function Ee(a,b,c,d){b=a.h.listeners[String(b)];if(!b)return!0;b=b.concat();for(var e=!0,f=0;f<b.length;++f){var g=b[f];if(g&&!g.Y&&g.capture==c){var h=g.listener,k=g.ia||g.src;g.ga&&me(a.h,g);e=!1!==h.call(k,d)&&e}}return e&&!d.defaultPrevented}
...
function cf(a,b,c,d){if(b=a.j[b]){var e=a.h;(b=bb(b,function(f){return e[f+1]==c&&e[f+2]==d}))&&a.X(b)}}
m.X=function(a){var b=this.h[a];if(b){var c=this.j[b];0!=this.m?(this.l.push(a),this.h[a+1]=Ja):(c&&cb(c,a),delete this.h[a],delete this.h[a+1],delete this.h[a+2])}return!!b};
...
m.clear=function(a){if(a){var b=this.j[a];b&&(G(b,this.X,this),delete this.j[a])}else this.h.length=0,this.j={}};
...
;function ag(){var a=bg;y("yt.ads.biscotti.getId_")||x("yt.ads.biscotti.getId_",a,void 0)}
function cg(a){x("yt.ads.biscotti.lastId_",a,void 0)}
;var dg=/^[\w.]*$/,eg={q:!0,search_query:!0};function fg(a,b){for(var c=a.split(b),d={},e=0,f=c.length;e<f;e++){var g=c[e].split("=");if(1==g.length&&g[0]||2==g.length)try{var h=gg(g[0]||""),k=gg(g[1]||"");h in d?Array.isArray(d[h])?eb(d[h],k):d[h]=[d[h],k]:d[h]=k}catch(q){var l=q,n=g[0],p=String(fg);l.args=[{key:n,value:g[1],query:a,method:hg==p?"unchanged":p}];eg.hasOwnProperty(n)||Af(l)}}return d}
var hg=String(fg);function ig(a){var b=[];fb(a,function(c,d){var e=encodeURIComponent(String(d)),f;Array.isArray(c)?f=c:f=[c];G(f,function(g){""==g?b.push(e):b.push(e+"="+encodeURIComponent(String(g)))})});
return b.join("&")}
function jg(a){"?"==a.charAt(0)&&(a=a.substr(1));return fg(a,"&")}
function kg(a,b,c){var d=a.split("#",2);a=d[0];d=1<d.length?"#"+d[1]:"";var e=a.split("?",2);a=e[0];e=jg(e[1]||"");for(var f in b)!c&&null!==e&&f in e||(e[f]=b[f]);return $b(a,e)+d}
function gg(a){return a&&a.match(dg)?a:decodeURIComponent(a.replace(/\+/g," "))}
;function lg(a){var b=mg;a=void 0===a?y("yt.ads.biscotti.lastId_")||"":a;var c=Object,d=c.assign,e={};e.dt=nd;e.flash="0";a:{try{var f=b.h.top.location.href}catch(da){f=2;break a}f=f?f===b.i.location.href?0:1:2}e=(e.frm=f,e);e.u_tz=-(new Date).getTimezoneOffset();var g=void 0===g?K:g;try{var h=g.history.length}catch(da){h=0}e.u_his=h;e.u_java=!!K.navigator&&"unknown"!==typeof K.navigator.javaEnabled&&!!K.navigator.javaEnabled&&K.navigator.javaEnabled();K.screen&&(e.u_h=K.screen.height,e.u_w=K.screen.width,
...
x("yt.ads_.signals_.getAdSignalsString",function(a){return ig(lg(a))},void 0);var ng="XMLHttpRequest"in w?function(){return new XMLHttpRequest}:null;
...
rg="app debugcss debugjs expflag force_ad_params force_viral_ad_response_params forced_experiments innertube_snapshots innertube_goldens internalcountrycode internalipoverride absolute_experiments conditional_experiments sbb sr_bns_address client_dev_root_url".split(" "),sg=!1;
function tg(a,b){b=void 0===b?{}:b;if(!c)var c=window.location.href;var d=a.match(Vb)[1]||null,e=Xb(a);d&&e?(d=c,c=a.match(Vb),d=d.match(Vb),c=c[3]==d[3]&&c[1]==d[1]&&c[4]==d[4]):c=e?Xb(c)==e&&(Number(c.match(Vb)[4]||null)||null)==(Number(a.match(Vb)[4]||null)||null):!0;d=P("web_ajax_ignore_global_headers_if_set");for(var f in qg)e=H(qg[f]),!e||!c&&Xb(a)||d&&void 0!==b[f]||(b[f]=e);if(c||!Xb(a))b["X-YouTube-Utc-Offset"]=String(-(new Date).getTimezoneOffset());(c||!Xb(a))&&(f="undefined"!=typeof Intl?
(new Intl.DateTimeFormat).resolvedOptions().timeZone:null)&&(b["X-YouTube-Time-Zone"]=f);if(c||!Xb(a))b["X-YouTube-Ad-Signals"]=ig(lg(void 0));return b}
function ug(a){var b=window.location.search,c=Xb(a),d=Wb(a.match(Vb)[5]||null);d=(c=c&&(c.endsWith("youtube.com")||c.endsWith("youtube-nocookie.com")))&&d&&d.startsWith("/api/");if(!c||d)return a;var e=jg(b),f={};G(rg,function(g){e[g]&&(f[g]=e[g])});
return kg(a,f||{},!1)}
...
b.onFetchTimeout&&0<b.timeout&&(f=Q(function(){e||(e=!0,Pf(f),b.onFetchTimeout.call(b.context||w))},b.timeout))}else yg(a,b)}
function yg(a,b){var c=b.format||"JSON";a=wg(a,b);var d=xg(a,b),e=!1,f=zg(a,function(k){if(!e){e=!0;h&&Pf(h);var l=pg(k),n=null,p=400<=k.status&&500>k.status,q=500<=k.status&&600>k.status;if(l||p||q)n=Ag(a,c,k,b.convertToSafeHtml);if(l)a:if(k&&204==k.status)l=!0;else{switch(c){case "XML":l=0==parseInt(n&&n.return_code,10);break a;case "RAW":l=!0;break a}l=!!n}n=n||{};p=b.context||w;l?b.onSuccess&&b.onSuccess.call(p,k,n):b.onError&&b.onError.call(p,k,n);b.onFinish&&b.onFinish.call(p,k,n)}},b.method,
...
function wg(a,b){b.includeDomain&&(a=document.location.protocol+"//"+document.location.hostname+(document.location.port?":"+document.location.port:"")+a);var c=H("XSRF_FIELD_NAME",void 0),d=b.urlParams;d&&(d[c]&&delete d[c],a=kg(a,d||{},!0));return a}
function xg(a,b){var c=H("XSRF_FIELD_NAME",void 0),d=H("XSRF_TOKEN",void 0),e=b.postBody||"",f=b.postParams,g=H("XSRF_FIELD_NAME",void 0),h;b.headers&&(h=b.headers["Content-Type"]);b.excludeXsrf||Xb(a)&&!b.withCredentials&&Xb(a)!=document.location.hostname||"POST"!=b.method||h&&"application/x-www-form-urlencoded"!=h||b.postParams&&b.postParams[g]||(f||(f={}),f[c]=d);f&&"string"===typeof e&&(e=jg(e),pb(e,f),e=b.postBodyFormat&&"JSON"==b.postBodyFormat?JSON.stringify(e):Zb(e));f=e||f&&!ib(f);!sg&&f&&
"POST"!=b.method&&(sg=!0,zf(Error("AJAX request with postData should use POST")));return e}
function Ag(a,b,c,d){var e=null;switch(b){case "JSON":try{var f=c.responseText}catch(g){throw d=Error("Error reading responseText"),d.params=a,Af(d),g;}a=c.getResponseHeader("Content-Type")||"";f&&0<=a.indexOf("json")&&(")]}'\n"===f.substring(0,5)&&(f=f.substring(5)),e=JSON.parse(f));break;case "XML":if(a=(a=c.responseXML)?Bg(a):null)e={},G(a.getElementsByTagName("*"),function(g){e[g.tagName]=Cg(g)})}d&&Dg(e);
return e}
function Dg(a){if(B(a))for(var b in a){var c;(c="html_content"==b)||(c=b.length-5,c=0<=c&&b.indexOf("_html",c)==c);if(c){c=b;var d=Qb(a[b],null);a[c]=d}else Dg(a[b])}}
function Bg(a){return a?(a=("responseXML"in a?a.responseXML:a).getElementsByTagName("root"))&&0<a.length?a[0]:null:null}
function Cg(a){var b="";G(a.childNodes,function(c){b+=c.nodeValue});
return b}
function zg(a,b,c,d,e,f,g){function h(){4==(k&&"readyState"in k?k.readyState:0)&&b&&yf(b)(k)}
c=void 0===c?"GET":c;d=void 0===d?"":d;var k=og();if(!k)return null;"onloadend"in k?k.addEventListener("loadend",h,!1):k.onreadystatechange=h;P("debug_forward_web_query_parameters")&&(a=ug(a));k.open(c,a,!0);f&&(k.responseType=f);g&&(k.withCredentials=!0);c="POST"==c&&(void 0===window.FormData||!(d instanceof FormData));if(e=tg(a,e))for(var l in e)k.setRequestHeader(l,e[l]),"content-type"==l.toLowerCase()&&(c=!1);c&&k.setRequestHeader("Content-Type","application/x-www-form-urlencoded");k.send(d);
return k}
;var Eg=uc||vc;function Fg(a){var b=Lb;return b?0<=b.toLowerCase().indexOf(a):!1}
;var Gg={},Hg=0;
function Ig(a,b,c,d,e){e=void 0===e?"":e;if(a)if(c&&!Fg("cobalt")){if(a){a instanceof I||(a="object"==typeof a&&a.W?a.V():String(a),Ib.test(a)?a=new I(a,Eb):(a=String(a),a=a.replace(/(%0A|%0D)/g,""),a=(b=a.match(Hb))&&Gb.test(b[1])?new I(a,Eb):null));a=Fb(a||Kb);if("about:invalid#zClosurez"===a||a.startsWith("data"))a="";else{if(!(a instanceof Ob)){b="object"==typeof a;var f=null;b&&a.qa&&(f=a.ma());a=Qb(wb(b&&a.W?a.V():String(a)),f)}a instanceof Ob&&a.constructor===Ob?a=a.h:(La(a),a="type_error:SafeHtml");
a=encodeURIComponent(String(Fe(a.toString())))}/^[\s\xa0]*$/.test(a)||(a=Gc("IFRAME",{src:'javascript:"<body><img src=\\""+'+a+'+"\\"></body>"',style:"display:none"}),(9==a.nodeType?a:a.ownerDocument||a.document).body.appendChild(a))}}else if(e)zg(a,b,"POST",e,d);else if(H("USE_NET_AJAX_FOR_PING_TRANSPORT",!1)||d)zg(a,b,"GET","",d);else{b:{try{var g=new Wa({url:a});if(g.j&&g.i||g.l){var h=Wb(a.match(Vb)[5]||null),k;if(!(k=!h||!h.endsWith("/aclk"))){var l=a.search(ac);d:{for(c=0;0<=(c=a.indexOf("ri",
c))&&c<l;){var n=a.charCodeAt(c-1);if(38==n||63==n){var p=a.charCodeAt(c+2);if(!p||61==p||38==p||35==p){var q=c;break d}}c+=3}q=-1}if(0>q)var r=null;else{var z=a.indexOf("&",q);if(0>z||z>l)z=l;q+=3;r=decodeURIComponent(a.substr(q,z-q).replace(/\+/g," "))}k="1"!==r}f=!k;break b}}catch(A){}f=!1}f?Jg(a)?(b&&b(),f=!0):f=!1:f=!1;f||Kg(a,b)}}
function Lg(a){var b=void 0===b?"":b;Jg(a,b)||Ig(a,void 0,void 0,void 0,b)}
...
c.src=a}
;var Mg=w.ytPubsubPubsubInstance||new N,Ng=w.ytPubsubPubsubSubscribedKeys||{},Og=w.ytPubsubPubsubTopicToKeys||{},Pg=w.ytPubsubPubsubIsSynchronous||{};function Qg(a,b){var c=Rg();if(c&&b){var d=c.subscribe(a,function(){var e=arguments;var f=function(){Ng[d]&&b.apply&&"function"==typeof b.apply&&b.apply(window,e)};
try{Pg[a]?f():Q(f,0)}catch(g){zf(g)}},void 0);
Ng[d]=!0;Og[a]||(Og[a]=[]);Og[a].push(d);return d}return 0}
function Sg(a){var b=Rg();b&&("number"===typeof a?a=[a]:"string"===typeof a&&(a=[parseInt(a,10)]),G(a,function(c){b.unsubscribeByKey(c);delete Ng[c]}))}
...
function Rg(){return w.ytPubsubPubsubInstance}
function Vg(a){Og[a]&&(a=Og[a],G(a,function(b){Ng[b]&&delete Ng[b]}),a.length=0)}
N.prototype.subscribe=N.prototype.subscribe;N.prototype.unsubscribeByKey=N.prototype.X;N.prototype.publish=N.prototype.O;N.prototype.clear=N.prototype.clear;x("ytPubsubPubsubInstance",Mg,void 0);x("ytPubsubPubsubTopicToKeys",Og,void 0);x("ytPubsubPubsubIsSynchronous",Pg,void 0);x("ytPubsubPubsubSubscribedKeys",Ng,void 0);var Wg=window,R=Wg.ytcsi&&Wg.ytcsi.now?Wg.ytcsi.now:Wg.performance&&Wg.performance.timing&&Wg.performance.now&&Wg.performance.timing.navigationStart?function(){return Wg.performance.timing.navigationStart+Wg.performance.now()}:function(){return(new Date).getTime()};var Xg=Ef("initial_gel_batch_timeout",1E3),Yg=Math.pow(2,16)-1,Zg=null,$g=0,ah=void 0,bh=0,ch=0,dh=0,eh=!0,fh=w.ytLoggingTransportGELQueue_||new Map;x("ytLoggingTransportGELQueue_",fh,void 0);var gh=w.ytLoggingTransportTokensToCttTargetIds_||{};x("ytLoggingTransportTokensToCttTargetIds_",gh,void 0);
function hh(a,b){if("log_event"===a.endpoint){var c="";a.C&&(gh[a.C.token]=ih(a.C),c=a.C.token);var d=fh.get(c)||[];fh.set(c,d);d.push(a.payload);b&&(ah=new b);c=Ef("web_logging_max_batch")||100;var e=R();d.length>=c?jh({writeThenSend:!0}):10<=e-dh&&(kh(),dh=e)}}
function lh(a,b){if("log_event"===a.endpoint){var c="";a.C&&(gh[a.C.token]=ih(a.C),c=a.C.token);var d=new Map;d.set(c,[a.payload]);b&&(ah=new b);return new M(function(e){ah&&ah.isReady()?mh(d,e,{bypassNetworkless:!0}):e()})}}
function jh(a){a=void 0===a?{}:a;return new M(function(b){Pf(bh);Pf(ch);ch=0;ah&&ah.isReady()?(mh(fh,b,a),fh.clear()):(kh(),b())})}
function kh(){P("web_gel_timeout_cap")&&!ch&&(ch=Q(jh,6E4));Pf(bh);var a=H("LOGGING_BATCH_TIMEOUT",Ef("web_gel_debounce_ms",1E4));P("shorten_initial_gel_batch_timeout")&&eh&&(a=Xg);bh=Q(function(){jh({writeThenSend:!0})},a)}
function mh(a,b,c){var d=ah;c=void 0===c?{}:c;var e=Math.round(R()),f=a.size;a=u(a);for(var g=a.next();!g.done;g=a.next()){var h=u(g.value);g=h.next().value;var k=h.next().value;h=nb({context:nh(d.h||oh())});h.events=k;(k=gh[g])&&ph(h,g,k);delete gh[g];qh(h,e);P("send_beacon_before_gel")&&window.navigator&&window.navigator.sendBeacon&&!c.writeThenSend&&Lg("/generate_204");rh(d,"log_event",h,{retry:!0,onSuccess:function(){f--;f||b();$g=Math.round(R()-e)},
onError:function(){f--;f||b()},
Ca:c});eh=!1}}
function qh(a,b){a.requestTimeMs=String(b);P("unsplit_gel_payloads_in_logs")&&(a.unsplitGelPayloadsInLogs=!0);var c=H("EVENT_ID",void 0);if(c){var d=H("BATCH_CLIENT_COUNTER",void 0)||0;!d&&P("web_client_counter_random_seed")&&(d=Math.floor(Math.random()*Yg/2));d++;d>Yg&&(d=1);O("BATCH_CLIENT_COUNTER",d);c={serializedEventId:c,clientCounter:String(d)};a.serializedClientEventId=c;Zg&&$g&&P("log_gel_rtt_web")&&(a.previousBatchInfo={serializedClientEventId:Zg,roundtripMs:String($g)});Zg=c;$g=0}}
...
;var sh=w.ytLoggingGelSequenceIdObj_||{};x("ytLoggingGelSequenceIdObj_",sh,void 0);function th(a,b,c,d){d=void 0===d?{}:d;var e={};e.eventTimeMs=Math.round(d.timestamp||R());e[a]=b;a=$f();e.context={lastActivityMs:String(d.timestamp||!isFinite(a)?-1:a)};P("log_sequence_info_on_gel_web")&&d.M&&(a=e.context,b=d.M,sh[b]=b in sh?sh[b]+1:0,a.sequence={index:sh[b],groupKey:b},d.La&&delete sh[d.M]);(d.Jk?lh:hh)({endpoint:"log_event",payload:e,C:d.C},c)}
;function uh(a,b,c,d){md.set(""+a,b,{Aa:c,path:"/",domain:void 0===d?"youtube.com":d,secure:!1})}
;var S=y("ytglobal.prefsUserPrefsPrefs_")||{};x("ytglobal.prefsUserPrefsPrefs_",S,void 0);function vh(){this.h=H("ALT_PREF_COOKIE_NAME","PREF");this.i=H("ALT_PREF_COOKIE_DOMAIN","youtube.com");var a=md.get(""+this.h,void 0);if(a){a=decodeURIComponent(a).split("&");for(var b=0;b<a.length;b++){var c=a[b].split("="),d=c[0];(c=c[1])&&(S[d]=c.toString())}}}
m=vh.prototype;m.get=function(a,b){wh(a);xh(a);var c=void 0!==S[a]?S[a].toString():null;return null!=c?c:b?b:""};
m.set=function(a,b){wh(a);xh(a);if(null==b)throw Error("ExpectedNotNull");S[a]=b.toString()};
m.remove=function(a){wh(a);xh(a);delete S[a]};
m.save=function(){var a=this.h,b=[],c;for(c in S)b.push(c+"="+encodeURIComponent(String(S[c])));uh(a,b.join("&"),63072E3,this.i)};
m.clear=function(){for(var a in S)delete S[a]};
...
function yh(a){a=void 0!==S[a]?S[a].toString():null;return null!=a&&/^[A-Fa-f0-9]+$/.test(a)?parseInt(a,16):null}
Ka(vh);var zh={bluetooth:"CONN_DISCO",cellular:"CONN_CELLULAR_UNKNOWN",ethernet:"CONN_WIFI",none:"CONN_NONE",wifi:"CONN_WIFI",wimax:"CONN_CELLULAR_4G",other:"CONN_UNKNOWN",unknown:"CONN_UNKNOWN","slow-2g":"CONN_CELLULAR_2G","2g":"CONN_CELLULAR_2G","3g":"CONN_CELLULAR_3G","4g":"CONN_CELLULAR_4G"};function Ah(){return"INNERTUBE_API_KEY"in vf&&"INNERTUBE_API_VERSION"in vf}
function oh(){return{innertubeApiKey:H("INNERTUBE_API_KEY",void 0),innertubeApiVersion:H("INNERTUBE_API_VERSION",void 0),Ra:H("INNERTUBE_CONTEXT_CLIENT_CONFIG_INFO"),Sa:H("INNERTUBE_CONTEXT_CLIENT_NAME","WEB"),innertubeContextClientVersion:H("INNERTUBE_CONTEXT_CLIENT_VERSION",void 0),Ua:H("INNERTUBE_CONTEXT_HL",void 0),Ta:H("INNERTUBE_CONTEXT_GL",void 0),Va:H("INNERTUBE_HOST_OVERRIDE",void 0)||"",Xa:!!H("INNERTUBE_USE_THIRD_PARTY_AUTH",!1),Wa:!!H("INNERTUBE_OMIT_API_KEY_WHEN_AUTH_HEADER_IS_PRESENT",
!1),appInstallData:H("SERIALIZED_CLIENT_CONFIG_DATA",void 0)}}
function nh(a){var b={client:{hl:a.Ua,gl:a.Ta,clientName:a.Sa,clientVersion:a.innertubeContextClientVersion,configInfo:a.Ra}},c=window.devicePixelRatio;c&&1!=c&&(b.client.screenDensityFloat=String(c));c=H("EXPERIMENTS_TOKEN","");""!==c&&(b.client.experimentsToken=c);c=[];var d=H("EXPERIMENTS_FORCED_FLAGS",{});for(e in d)c.push({key:e,value:String(d[e])});var e=H("EXPERIMENT_FLAGS",{});for(var f in e)f.startsWith("force_")&&void 0===d[f]&&c.push({key:f,value:String(e[f])});0<c.length&&(b.request={internalExperimentFlags:c});
a.appInstallData&&(b.client.configInfo=b.client.configInfo||{},b.client.configInfo.appInstallData=a.appInstallData);H("DELEGATED_SESSION_ID")&&!P("pageid_as_header_web")&&(b.user={onBehalfOfUser:H("DELEGATED_SESSION_ID")});if(P("web_log_connection_in_gel")){a:{if(f=(a=w.navigator)?a.connection:void 0){a=zh[f.type||"unknown"]||"CONN_UNKNOWN";f=zh[f.effectiveType||"unknown"]||"CONN_UNKNOWN";"CONN_CELLULAR_UNKNOWN"===a&&"CONN_UNKNOWN"!==f&&(a=f);if("CONN_UNKNOWN"!==a)break a;if("CONN_UNKNOWN"!==f){a=
f;break a}}a=void 0}a&&(b.client.connectionType=a)}a=Object;f=a.assign;e=b.client;c={};d=u(Object.entries(jg(H("DEVICE",""))));for(var g=d.next();!g.done;g=d.next()){var h=u(g.value);g=h.next().value;h=h.next().value;"cbrand"===g?c.deviceMake=h:"cmodel"===g?c.deviceModel=h:"cbr"===g?c.browserName=h:"cbrver"===g?c.browserVersion=h:"cos"===g?c.osName=h:"cosver"===g?c.osVersion=h:"cplatform"===g&&(c.platform=h)}b.client=f.call(a,e,c);return b}
function Bh(a,b,c){c=void 0===c?{}:c;var d={"X-Goog-Visitor-Id":c.visitorData||H("VISITOR_DATA","")};if(b&&b.includes("www.youtube-nocookie.com"))return d;(b=c.yk||H("AUTHORIZATION"))||(a?b="Bearer "+y("gapi.auth.getToken")().xk:b=wd([]));b&&(d.Authorization=b,d["X-Goog-AuthUser"]=H("SESSION_INDEX",0),P("pageid_as_header_web")&&(d["X-Goog-PageId"]=H("DELEGATED_SESSION_ID")));return d}
;function Ch(a){a=Object.assign({},a);delete a.Authorization;var b=wd();if(b){var c=new Od;c.update(H("INNERTUBE_API_KEY",void 0));c.update(b);a.hash=zc(c.digest())}return a}
;function Dh(a){var b=new nf;(b=b.isAvailable()?a?new tf(b,a):b:null)||(a=new of(a||"UserDataSharedStore"),b=a.isAvailable()?a:null);this.h=(a=b)?new jf(a):null;this.i=document.domain||window.location.hostname}
Dh.prototype.set=function(a,b,c,d){c=c||31104E3;this.remove(a);if(this.h)try{this.h.set(a,b,E()+1E3*c);return}catch(f){}var e="";if(d)try{e=escape(Fe(b))}catch(f){return}else e=escape(b);uh(a,e,c,this.i)};
Dh.prototype.get=function(a,b){var c=void 0,d=!this.h;if(!d)try{c=this.h.get(a)}catch(e){d=!0}if(d&&(c=md.get(""+a,void 0))&&(c=unescape(c),b))try{c=JSON.parse(c)}catch(e){this.remove(a),c=void 0}return c};
Dh.prototype.remove=function(a){this.h&&this.h.remove(a);var b=this.i;md.remove(""+a,"/",void 0===b?"youtube.com":b)};var Eh;function Fh(){Eh||(Eh=new Dh("yt.innertube"));return Eh}
...
function Ih(a){var b=Fh().get("requests",!0);if(b){for(var c in b){var d=b[c];if(!(6E4>Math.round(R())-d.requestTime)){var e=d.authState,f=Ch(Bh(!1));lb(e,f)&&(e=d.request,"requestTimeMs"in e&&(e.requestTimeMs=Math.round(R())),rh(a,d.method,e,{}));delete b[c]}}Fh().set("requests",b,86400,!0)}}
;function Jh(a,b){this.version=a;this.args=b}
;function Kh(a,b){this.topic=a;this.h=b}
Kh.prototype.toString=function(){return this.topic};var Lh=y("ytPubsub2Pubsub2Instance")||new N;N.prototype.subscribe=N.prototype.subscribe;N.prototype.unsubscribeByKey=N.prototype.X;N.prototype.publish=N.prototype.O;N.prototype.clear=N.prototype.clear;x("ytPubsub2Pubsub2Instance",Lh,void 0);var Mh=y("ytPubsub2Pubsub2SubscribedKeys")||{};x("ytPubsub2Pubsub2SubscribedKeys",Mh,void 0);var Nh=y("ytPubsub2Pubsub2TopicToKeys")||{};x("ytPubsub2Pubsub2TopicToKeys",Nh,void 0);var Oh=y("ytPubsub2Pubsub2IsAsync")||{};x("ytPubsub2Pubsub2IsAsync",Oh,void 0);
x("ytPubsub2Pubsub2SkipSubKey",null,void 0);function Ph(a,b){var c=Qh();c&&c.publish.call(c,a.toString(),a,b)}
function Rh(a){var b=Sh,c=Qh();if(!c)return 0;var d=c.subscribe(b.toString(),function(e,f){var g=y("ytPubsub2Pubsub2SkipSubKey");g&&g==d||(g=function(){if(Mh[d])try{if(f&&b instanceof Kh&&b!=e)try{var h=b.h,k=f;if(!k.args||!k.version)throw Error("yt.pubsub2.Data.deserialize(): serializedData is incomplete.");try{if(!h.N){var l=new h;h.N=l.version}var n=h.N}catch(p){}if(!n||k.version!=n)throw Error("yt.pubsub2.Data.deserialize(): serializedData version is incompatible.");try{f=Reflect.construct(h,
db(k.args))}catch(p){throw p.message="yt.pubsub2.Data.deserialize(): "+p.message,p;}}catch(p){throw p.message="yt.pubsub2.pubsub2 cross-binary conversion error for "+b.toString()+": "+p.message,p;}a.call(window,f)}catch(p){zf(p)}},Oh[b.toString()]?y("yt.scheduler.instance")?Sf(g):Q(g,0):g())});
...
return b}
function Vh(a){var b=Qh();b&&("number"===typeof a&&(a=[a]),G(a,function(c){b.unsubscribeByKey(c);delete Mh[c]}))}
function Qh(){return y("ytPubsub2Pubsub2Instance")}
;var Wh=[],Xh=!1;function Yh(a,b){Xh||(Wh.push({type:"EVENT",eventType:a,payload:b}),10<Wh.length&&Wh.shift())}
;function T(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];d=Error.call(this,a);this.message=d.message;"stack"in d&&(this.stack=d.stack);this.args=[].concat(c instanceof Array?c:ha(u(c)))}
v(T,Error);var Zh={},$h=(Zh.AUTH_INVALID="No user identifier specified.",Zh.EXPLICIT_ABORT="Transaction was explicitly aborted.",Zh.IDB_NOT_SUPPORTED="IndexedDB is not supported.",Zh.MISSING_OBJECT_STORE="Object store not created.",Zh.UNKNOWN_ABORT="Transaction was aborted for unknown reasons.",Zh.QUOTA_EXCEEDED="The current transaction exceeded its quota limitations.",Zh.QUOTA_MAYBE_EXCEEDED="The current transaction may have failed because of exceeding quota limitations.",Zh.EXECUTE_TRANSACTION_ON_CLOSED_DB=
"Can't start a transaction on a closed database",Zh),ai={},bi=(ai.AUTH_INVALID="ERROR",ai.EXECUTE_TRANSACTION_ON_CLOSED_DB="WARNING",ai.EXPLICIT_ABORT="IGNORED",ai.IDB_NOT_SUPPORTED="ERROR",ai.MISSING_OBJECT_STORE="ERROR",ai.QUOTA_EXCEEDED="WARNING",ai.QUOTA_MAYBE_EXCEEDED="WARNING",ai.UNKNOWN_ABORT="WARNING",ai);
function U(a,b,c,d){b=void 0===b?{}:b;c=void 0===c?$h[a]:c;d=void 0===d?bi[a]:d;T.call(this,c,Object.assign({name:"YtIdbKnownError",isSw:void 0===self.document,isIframe:self!==self.top,type:a,level:d},b));this.type=a;this.message=c;this.level=d;Object.setPrototypeOf(this,U.prototype)}
v(U,T);function ci(a){U.call(this,"MISSING_OBJECT_STORE",{Ek:a},$h.MISSING_OBJECT_STORE);Object.setPrototypeOf(this,ci.prototype)}
v(ci,U);var di=["The database connection is closing","Can't start a transaction on a closed database","A mutation operation was attempted on a database that did not allow mutations"];
function ei(a,b,c){if(a instanceof U||a instanceof T)return a;if("QuotaExceededError"===a.name)return new U("QUOTA_EXCEEDED",{objectStoreNames:c,dbName:b});if(wc&&"UnknownError"===a.name)return new U("QUOTA_MAYBE_EXCEEDED",{objectStoreNames:c,dbName:b});if("InvalidStateError"===a.name&&di.some(function(d){return a.message.includes(d)}))return new U("EXECUTE_TRANSACTION_ON_CLOSED_DB",{objectStoreNames:c,
dbName:b});Object.setPrototypeOf(a,T.prototype);a.args=[{name:"IdbError",Fk:a.name,dbName:b,objectStoreNames:c}];return a}
...
V.all=function(a){return new V(function(b,c){var d=[],e=a.length;0===e&&b(d);for(var f={R:0};f.R<a.length;f={R:f.R},++f.R)hi(V.resolve(a[f.R]).then(function(g){return function(h){d[g.R]=h;e--;0===e&&b(d)}}(f)),function(g){c(g)})})};
V.resolve=function(a){return new V(function(b,c){a instanceof V?a.then(b,c):b(a)})};
V.reject=function(a){return new V(function(b,c){c(a)})};
V.prototype.then=function(a,b){var c=this,d=null!==a&&void 0!==a?a:gi,e=null!==b&&void 0!==b?b:fi;return new V(function(f,g){"PENDING"===c.state.status?(c.h.push(function(){ii(c,c,d,f,g)}),c.onRejected.push(function(){ji(c,c,e,f,g)})):"FULFILLED"===c.state.status?ii(c,c,d,f,g):"REJECTED"===c.state.status&&ji(c,c,e,f,g)})};
function hi(a,b){return a.then(void 0,b)}
function ii(a,b,c,d,e){try{if("FULFILLED"!==a.state.status)throw Error("calling handleResolve before the promise is fulfilled.");var f=c(a.state.value);f instanceof V?ki(a,b,f,d,e):d(f)}catch(g){e(g)}}
function ji(a,b,c,d,e){try{if("REJECTED"!==a.state.status)throw Error("calling handleReject before the promise is rejected.");var f=c(a.state.reason);f instanceof V?ki(a,b,f,d,e):d(f)}catch(g){e(g)}}
function ki(a,b,c,d,e){b===c?e(new TypeError("Circular promise chain detected.")):c.then(function(f){f instanceof V?ki(a,b,f,d,e):d(f)},function(f){e(f)})}
...
function W(a){return new V(function(b,c){li(a,b,c)})}
;function ni(a,b){return new V(function(c,d){function e(){var f=a?b(a):null;f?f.then(function(g){a=g;e()},d):c()}
e()})}
;function oi(a,b){this.h=a;this.options=b;this.transactionCount=0;this.j=Math.round(R());this.i=!1}
m=oi.prototype;m.add=function(a,b,c){return pi(this,[a],{mode:"readwrite",U:P("ytidb_transaction_enable_retries_core_and_nwl")},function(d){return qi(d,a).add(b,c)})};
m.clear=function(a){return pi(this,[a],{mode:"readwrite",U:P("ytidb_transaction_enable_retries_core_and_nwl")},function(b){return qi(b,a).clear()})};
m.close=function(){var a;this.h.close();(null===(a=this.options)||void 0===a?0:a.closed)&&this.options.closed()};
m.count=function(a,b){return pi(this,[a],{mode:"readonly",U:P("ytidb_transaction_enable_retries_core_and_nwl")},function(c){return qi(c,a).count(b)})};
m["delete"]=function(a,b){return pi(this,[a],{mode:"readwrite",U:P("ytidb_transaction_enable_retries_core_and_nwl")},function(c){return qi(c,a)["delete"](b)})};
m.get=function(a,b){return pi(this,[a],{mode:"readonly",U:P("ytidb_transaction_enable_retries_core_and_nwl")},function(c){return qi(c,a).get(b)})};
function pi(a,b,c,d){var e={mode:"readonly",U:!1};"string"===typeof c?e.mode=c:e=c;a.transactionCount++;try{var f=a.h.transaction(b,e.mode);var g=ri(f,d,e)["catch"](function(h){throw ei(h,a.h.name,b.join());})}catch(h){g=h instanceof Error?Promise.reject(ei(h,a.h.name,b.join())):Promise.reject(ei(Error("unexpected transaction error: "+h),a.h.name,b.join()))}si(a,g,b.join(),e);
return g}
function si(a,b,c,d){bc(a,function f(){var g,h,k=this,l,n,p;return Aa(f,function(q){if(1==q.h)return g=Math.round(R()),q.l=2,sa(q,b,4);2!=q.h?(h=Math.round(R()),ti(k,!0,c,h-g),q.h=0,q.l=0):(l=ta(q),n=Math.round(R()),p=n-g,l instanceof U&&("QUOTA_EXCEEDED"===l.type||"QUOTA_MAYBE_EXCEEDED"===l.type)&&Yh("QUOTA_EXCEEDED",{dbName:k.h.name,objectStoreNames:c,transactionCount:k.transactionCount,transactionMode:d.mode}),l instanceof U&&"UNKNOWN_ABORT"===l.type&&(Yh("TRANSACTION_UNEXPECTEDLY_ABORTED",{objectStoreNames:c,
transactionDuration:p,transactionCount:k.transactionCount,dbDuration:n-k.j}),k.i=!0),ti(k,!1,c,p),Xh||(Wh.push({type:"ERROR",payload:l}),10<Wh.length&&Wh.shift()),q.h=0)})})}
function ti(a,b,c,d){Yh("TRANSACTION_ENDED",{objectStoreNames:c,connectionHasUnknownAbortedTransaction:a.i,duration:d,isSuccessful:b})}
function ui(a){this.h=a}
m=ui.prototype;m.add=function(a,b){return W(this.h.add(a,b))};
...
m["delete"]=function(a){return a instanceof IDBKeyRange?vi(this,a):W(this.h["delete"](a))};
m.get=function(a){return W(this.h.get(a))};
m.index=function(a){return new xi(this.h.index(a))};
m.getName=function(){return this.h.name};
function wi(a,b,c){a=a.h.openCursor(b.query,b.direction);return yi(a).then(function(d){return ni(d,c)})}
function zi(a){var b=this;this.h=a;this.i=new Map;this.aborted=!1;this.done=new Promise(function(c,d){b.h.addEventListener("complete",function(){c()});
...
function ri(a,b,c){a=new zi(a);return Ai(a,b,c)}
function Ai(a,b,c){var d=new Promise(function(e,f){var g=Ef("ytidb_transaction_try_count",1),h=b(a);if(c.U)for(var k=0;k<g-1;k++)h=hi(h,function(l){return l instanceof U&&"EXPLICIT_ABORT"===l.type?V.reject(l):b(a)});
hi(h.then(function(l){a.commit();e(l)}),f)});
return Promise.all([d,a.done]).then(function(e){return u(e).next().value})}
zi.prototype.abort=function(){this.h.abort();this.aborted=!0;throw new U("EXPLICIT_ABORT");};
zi.prototype.commit=function(){var a=this.h;a.commit&&!this.aborted&&a.commit()};
function qi(a,b){var c=a.h.objectStore(b),d=a.i.get(c);d||(d=new ui(c),a.i.set(c,d));return d}
function xi(a){this.h=a}
xi.prototype.count=function(a){return W(this.h.count(a))};
xi.prototype["delete"]=function(a){return Bi(this,{query:a},function(b){return b["delete"]().then(function(){return b["continue"]()})})};
xi.prototype.get=function(a){return W(this.h.get(a))};
xi.prototype.getKey=function(a){return W(this.h.getKey(a))};
function Bi(a,b,c){a=a.h.openCursor(void 0===b.query?null:b.query,void 0===b.direction?"next":b.direction);return yi(a).then(function(d){return ni(d,c)})}
function Ci(a,b){this.request=a;this.cursor=b}
function yi(a){return W(a).then(function(b){return null===b?null:new Ci(a,b)})}
m=Ci.prototype;m.advance=function(a){this.cursor.advance(a);return yi(this.request)};
...
m.update=function(a){return W(this.cursor.update(a))};function Di(a,b,c){return bc(this,function e(){var f,g,h,k,l,n,p,q,r,z;return Aa(e,function(A){if(1==A.h)return f=self.indexedDB.open(a,b),g=c,h=g.blocked,k=g.blocking,l=g.rb,n=g.upgrade,p=g.closed,r=function(){q||(q=new oi(f.result,{closed:p}));return q},f.addEventListener("upgradeneeded",function(D){if(null===D.newVersion)throw Error("Invariant: newVersion on IDbVersionChangeEvent is null");
if(null===f.transaction)throw Error("Invariant: transaction on IDbOpenDbRequest is null");D.dataLoss&&"none"!==D.dataLoss&&Yh("IDB_DATA_CORRUPTED",{reason:D.dataLossMessage||"unknown reason",dbName:a});var da=r(),va=new zi(f.transaction);n&&n(da,D.oldVersion,D.newVersion,va)}),h&&f.addEventListener("blocked",function(){h()}),sa(A,mi(f),2);
z=A.m;k&&z.addEventListener("versionchange",function(){k(r())});
z.addEventListener("close",function(){Yh("IDB_UNEXPECTEDLY_CLOSED",{dbName:a,dbVersion:z.version});l&&l()});
return A["return"](r())})})}
function Ei(a,b){b=void 0===b?{}:b;return bc(this,function d(){var e,f,g;return Aa(d,function(h){e=self.indexedDB.deleteDatabase(a);f=b;(g=f.blocked)&&e.addEventListener("blocked",function(){g()});
return sa(h,mi(e),0)})})}
;function Fi(a){this.name="YtIdbMeta";this.options=a;this.i=!1}
function Gi(a,b,c){c=void 0===c?{}:c;c=void 0===c?{}:c;return Di(a,b,c)}
Fi.prototype["delete"]=function(a){a=void 0===a?{}:a;return Ei(this.name,a)};
function Hi(){var a=Ii;if(!a.h){var b=function(){a.h===e&&(a.h=void 0)},c={blocking:function(f){f.close()},
closed:b,rb:b,upgrade:a.options.upgrade},d=function(){return bc(a,function g(){var h=this,k,l,n;return Aa(g,function(p){switch(p.h){case 1:return p.l=2,sa(p,Gi(h.name,h.options.version,c),4);case 4:k=p.m;if(!tc){p.h=5;break}a:{var q=u(Object.keys(h.options.ab));for(var r=q.next();!r.done;r=q.next())if(r=r.value,!k.h.objectStoreNames.contains(r)){q=r;break a}q=void 0}l=q;if(void 0===l){p.h=5;break}if(!tc||h.i){p.h=7;break}h.i=!0;return sa(p,h["delete"](),8);case 8:return p["return"](d());case 7:throw new ci(l);
case 5:return p["return"](k);case 2:n=ta(p);if(n instanceof DOMException?"VersionError"===n.name:"DOMError"in self&&n instanceof DOMError?"VersionError"===n.name:n instanceof Object&&"message"in n&&"An attempt was made to open a database using a lower version than the existing version."===n.message)return p["return"](Gi(h.name,void 0,Object.assign(Object.assign({},c),{upgrade:void 0})));b();throw n;}})})};
var e=d();a.h=e}return a.h}
;var Ii=new Fi({ab:{databases:!0},upgrade:function(a,b){1>b&&a.h.createObjectStore("databases",{keyPath:"actualName"})}});
function Ji(a){return bc(this,function c(){var d;return Aa(c,function(e){if(1==e.h)return sa(e,Hi(),2);d=e.m;return e["return"](pi(d,["databases"],"readwrite",function(f){var g=qi(f,"databases");return g.get(a.actualName).then(function(h){if(h?a.actualName!==h.actualName||a.publicName!==h.publicName||a.userIdentifier!==h.userIdentifier||a.clearDataOnAuthChange!==h.clearDataOnAuthChange:1)return W(g.h.put(a,void 0)).then(function(){})})}))})})}
function Ki(){return bc(this,function b(){var c;return Aa(b,function(d){if(1==d.h)return sa(d,Hi(),2);c=d.m;return d["return"](c["delete"]("databases","yt-idb-test-do-not-use"))})})}
;var Li;
function Mi(){return bc(this,function b(){var c,d;return Aa(b,function(e){switch(e.h){case 1:var f;if(f=Eg)f=/WebKit\/([0-9]+)/.exec(Lb),f=!!(f&&600<=parseInt(f[1],10));f&&(f=/WebKit\/([0-9]+)/.exec(Lb),f=!(f&&602<=parseInt(f[1],10)));if(f&&!P("ytidb_allow_on_ios_safari_v8_and_v9")||gc)return e["return"](!1);try{if(c=self,!(c.indexedDB&&c.IDBIndex&&c.IDBKeyRange&&c.IDBObjectStore))return e["return"](!1)}catch(g){return e["return"](!1)}if(!("IDBTransaction"in self&&"objectStoreNames"in IDBTransaction.prototype))return e["return"](!1);e.l=
2;d={actualName:"yt-idb-test-do-not-use",publicName:"yt-idb-test-do-not-use",userIdentifier:void 0};return sa(e,Ji(d),4);case 4:return sa(e,Ki(),5);case 5:return e["return"](!0);case 2:return ta(e),e["return"](!1)}})})}
function Ni(){if(void 0!==Li)return Li;Xh=!0;return Li=Mi().then(function(a){Xh=!1;return a})}
;var Oi;function Pi(){Oi||(Oi=new Dh("yt.offline"));return Oi}
;function Qi(){Ce.call(this);this.o=this.u=this.j=!1;this.l=Ri();Si(this);Ti(this)}
v(Qi,Ce);function Ri(){var a=window.navigator.onLine;return void 0===a?!0:a}
function Ti(a){window.addEventListener("online",function(){a.l=!0;a.j&&De(a,"ytnetworkstatus-online");Ui(a);if(a.o&&P("offline_error_handling")){var b=Pi().get("errors",!0);if(b){for(var c in b)if(b[c]){var d=new T(c,"sent via offline_errors");d.name=b[c].name;d.stack=b[c].stack;d.level=b[c].level||b[c].Ck;zf(d)}Pi().set("errors",{},2592E3,!0)}}})}
function Si(a){window.addEventListener("offline",function(){a.l=!1;a.j&&De(a,"ytnetworkstatus-offline");Ui(a)})}
function Ui(a){a.u&&(Af(new T("NetworkStatusManager state did not match poll",R()-0)),a.u=!1)}
;function Vi(a){a=void 0===a?{}:a;Ce.call(this);var b=this;this.l=this.u=0;Qi.h||(Qi.h=new Qi);this.j=Qi.h;this.j.j=!0;a.Za&&(this.j.o=!0);a.ja?(this.ja=a.ja,te(this.j,"ytnetworkstatus-online",function(){Wi(b,"publicytnetworkstatus-online")}),te(this.j,"ytnetworkstatus-offline",function(){Wi(b,"publicytnetworkstatus-offline")})):(te(this.j,"ytnetworkstatus-online",function(){De(b,"publicytnetworkstatus-online")}),te(this.j,"ytnetworkstatus-offline",function(){De(b,"publicytnetworkstatus-offline")}))}
v(Vi,Ce);function Wi(a,b){a.ja?a.l?(Vf(a.u),a.u=Sf(function(){a.o!==b&&(De(a,b),a.o=b,a.l=R())},a.ja-(R()-a.l))):(De(a,b),a.o=b,a.l=R()):De(a,b)}
;var Xi;function Yi(a,b){b=void 0===b?{}:b;Ni().then(function(){Xi||(Xi=new Vi({Za:!0}));Xi.j.l!==Ri()&&Af(new T("NetworkStatusManager isOnline does not match window status"));yg(a,b)})}
function Zi(a,b){b=void 0===b?{}:b;Ni().then(function(){yg(a,b)})}
;function $i(a){var b=this;this.h=null;a?this.h=a:Ah()&&(this.h=oh());Tf(function(){Ih(b)},0,5E3)}
$i.prototype.isReady=function(){!this.h&&Ah()&&(this.h=oh());return!!this.h};
function rh(a,b,c,d){!H("VISITOR_DATA")&&"visitor_id"!==b&&.01>Math.random()&&Af(new T("Missing VISITOR_DATA when sending innertube request.",b,c,d));if(!a.isReady()){var e=new T("innertube xhrclient not ready",b,c,d);zf(e);throw e;}var f={headers:{"Content-Type":"application/json"},method:"POST",postParams:c,postBodyFormat:"JSON",onTimeout:function(){d.onTimeout()},
...
timeout:d.timeout,withCredentials:!0},g="";(e=a.h.Va)&&(g=e);var h=a.h.Xa||!1,k=Bh(h,g,d);Object.assign(f.headers,k);f.headers.Authorization&&!g&&(f.headers["x-origin"]=window.location.origin);e="/youtubei/"+a.h.innertubeApiVersion+"/"+b;var l={alt:"json"};a.h.Wa&&f.headers.Authorization||(l.key=a.h.innertubeApiKey);var n=kg(""+g+e,l||{},!0);Ni().then(function(p){if(d.retry&&P("retry_web_logging_batches")&&"www.youtube-nocookie.com"!=g){if(P("networkless_gel")&&!p||!P("networkless_gel"))var q=Gh(b,
c,k,h);if(q){var r=f.onSuccess,z=f.onFetchSuccess;f.onSuccess=function(A,D){Hh(q);r(A,D)};
c.onFetchSuccess=function(A,D){Hh(q);z(A,D)}}}try{P("use_fetch_for_op_xhr")?vg(n,f):P("networkless_gel")&&d.retry&&!d.Ca.bypassNetworkless?(f.method="POST",!d.Ca.writeThenSend&&P("nwl_send_fast_on_unload")?Zi(n,f):Yi(n,f)):(f.method="POST",f.postParams||(f.postParams={}),yg(n,f))}catch(A){if("InvalidAccessError"==A.name)q&&(Hh(q),q=0),Af(Error("An extension is blocking network request."));
else throw A;}q&&Tf(function(){Ih(a)},0,5E3)})}
;function X(a,b,c){c=void 0===c?{}:c;var d=$i;H("ytLoggingEventsDefaultDisabled",!1)&&$i==$i&&(d=null);th(a,b,d,c)}
;var aj=[{Ba:function(a){return"Cannot read property '"+a.key+"'"},
...
;var ej=new N;function fj(a){function b(){return a.charCodeAt(d++)}
...
lj))){var g=hd(a);d=g.message||"Unknown Error";e=g.name||"UnknownError";var h=g.stack||a.h||"Not available";h.startsWith(e+": "+d)&&(f=h.split("\n"),f.shift(),h=f.join("\n"));f=g.lineNumber||"Not available";g=g.fileName||"Not available";var k=0;if(a.hasOwnProperty("args")&&a.args&&a.args.length)for(var l=0;l<a.args.length&&!(k=hj(a.args[l],"params."+l,c,k),500<=k);l++);else if(a.hasOwnProperty("params")&&a.params){var n=a.params;if("object"===typeof a.params)for(l in n){if(n[l]){var p="params."+l,
q=jj(n[l]);c[p]=q;k+=p.length+q.length;if(500<k)break}}else c.params=jj(n)}if(oj.length)for(l=0;l<oj.length&&!(k=hj(oj[l],"params.context."+l,c,k),500<=k);l++);navigator.vendor&&!c.hasOwnProperty("vendor")&&(c["device.vendor"]=navigator.vendor);l={message:d,name:e,lineNumber:f,fileName:g,stack:h,params:c,sampleWeight:1};c=Number(a.columnNumber);isNaN(c)||(l.lineNumber=l.lineNumber+":"+c);if(P("sampleWeight_to_level_migration_killswitch")&&void 0!==a.sampleWeight)a=a.sampleWeight;else if("IGNORED"===
a.level)a=0;else a:{a=dj();c=u(a.i);for(d=c.next();!d.done;d=c.next())if(d=d.value,l.message&&l.message.match(d.Dk)){a=d.weight;break a}a=u(a.h);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.Ja(l)){a=c.weight;break a}a=1}l.sampleWeight=a;a=u(aj);for(c=a.next();!c.done;c=a.next())if(c=c.value,c.sa[l.name])for(e=u(c.sa[l.name]),d=e.next();!d.done;d=e.next())if(f=d.value,d=l.message.match(f.regexp)){l.params["params.error.original"]=d[0];e=f.groups;f={};for(g=0;g<e.length;g++)f[e[g]]=d[g+1],l.params["params.error."+
e[g]]=d[g+1];l.message=c.Ba(f);break}l.params||(l.params={});a=dj();l.params["params.errorServiceSignature"]="msg="+a.i.length+"&cb="+a.h.length;l.params["params.serviceWorker"]="false";w.document&&w.document.querySelectorAll&&(l.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));window.yterr&&"function"===typeof window.yterr&&window.yterr(l);a=0===l.sampleWeight;if(!kj.has(l.message)&&!a){"ERROR"===b?(ej.O("handleError",l),P("record_app_crashed_web")&&0===
nj&&1===l.sampleWeight&&(nj++,X("appCrashed",{appCrashType:"APP_CRASH_TYPE_BREAKPAD"})),mj++):"WARNING"===b&&ej.O("handleWarning",l);if(P("kevlar_gel_error_routing")){c=b;a:{a=u(pj);for(d=a.next();!d.done;d=a.next())if(Fg(d.value.toLowerCase())){a=!0;break a}a=!1}if(!a){d={stackTrace:l.stack};l.fileName&&(d.filename=l.fileName);a=l.lineNumber&&l.lineNumber.split?l.lineNumber.split(":"):[];0!==a.length&&(1!==a.length||isNaN(Number(a[0]))?2!==a.length||isNaN(Number(a[0]))||isNaN(Number(a[1]))||(d.lineNumber=
Number(a[0]),d.columnNumber=Number(a[1])):d.lineNumber=Number(a[0]));a={level:"ERROR_LEVEL_UNKNOWN",message:l.message,errorClassName:l.name,sampleWeight:l.sampleWeight};"ERROR"===c?a.level="ERROR_LEVEL_ERROR":"WARNING"===c&&(a.level="ERROR_LEVEL_WARNNING");c={isObfuscated:!0,browserStackInfo:d};d={pageUrl:window.location.href,kvPairs:[]};H("FEXP_EXPERIMENTS")&&(d.experimentIds=H("FEXP_EXPERIMENTS"));if(e=l.params)for(f=u(Object.keys(e)),g=f.next();!g.done;g=f.next())g=g.value,d.kvPairs.push({key:"client."+
g,value:String(e[g])});e=H("SERVER_NAME",void 0);f=H("SERVER_VERSION",void 0);e&&f&&(d.kvPairs.push({key:"server.name",value:e}),d.kvPairs.push({key:"server.version",value:f}));X("clientError",{errorMetadata:d,stackTrace:c,logMessage:a});jh()}}if(!P("suppress_error_204_logging")){a=l.params||{};b={urlParams:{a:"logerror",t:"jserror",type:l.name,msg:l.message.substr(0,250),line:l.lineNumber,level:b,"client.name":a.name},postParams:{url:H("PAGE_NAME",window.location.href),file:l.fileName},method:"POST"};
a.version&&(b["client.version"]=a.version);if(b.postParams){l.stack&&(b.postParams.stack=l.stack);c=u(Object.keys(a));for(d=c.next();!d.done;d=c.next())d=d.value,b.postParams["client."+d]=a[d];if(a=H("LATEST_ECATCHER_SERVICE_TRACKING_PARAMS",void 0))for(c=u(Object.keys(a)),d=c.next();!d.done;d=c.next())d=d.value,b.postParams[d]=a[d];a=H("SERVER_NAME",void 0);c=H("SERVER_VERSION",void 0);a&&c&&(b.postParams["server.name"]=a,b.postParams["server.version"]=c)}yg(H("ECATCHER_REPORT_HOST","")+"/error_204",
b)}kj.add(l.message);lj++}}}
...
function Aj(a,b,c){c=void 0===c?null:c;var d=Bj(a),e=document.getElementById(d),f=e&&vj(e,"loaded"),g=e&&!f;f?b&&b():(b&&(f=Qg(d,b),b=""+Na(b),Cj[b]=f),g||(e=Dj(a,d,function(){vj(e,"loaded")||(tj(e),Tg(d),Q(Sa(Ug,d),0))},c)))}
function Dj(a,b,c,d){d=void 0===d?null:d;var e=Hc(document,"SCRIPT");e.id=b;e.onload=function(){c&&setTimeout(c,0)};
...
function Ej(a){a=Bj(a);var b=document.getElementById(a);b&&(Ug(a),b.parentNode.removeChild(b))}
function Fj(a,b){if(a&&b){var c=""+Na(b);(c=Cj[c])&&Sg(c)}}
function Bj(a){var b=document.createElement("a");Rb(b,a);a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"js-"+Ub(a)}
var Cj={};var Gj=[],Hj=!1;function Ij(){if(!P("disable_ad_status_on_html5_clients")&&(!P("condition_ad_status_fetch_on_consent_cookie_html5_clients")||md.get("CONSENT","").startsWith("YES+"))&&"1"!=kb()){var a=function(){Hj=!0;"google_ad_status"in window?O("DCLKSTAT",1):O("DCLKSTAT",2)};
try{zj("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}Gj.push(Sf(function(){if(!(Hj||"google_ad_status"in window)){try{Fj("//static.doubleclick.net/instream/ad_status.js",a)}catch(b){}Hj=!0;O("DCLKSTAT",3)}},5E3))}}
function Jj(){return parseInt(H("DCLKSTAT",0),10)}
;function Kj(){this.i=!1;this.h=null}
Kj.prototype.initialize=function(a,b,c,d,e,f){var g=this;f=void 0===f?!1:f;b?(this.i=!0,zj(b,function(){g.i=!1;var h=0<=b.indexOf("/th/");(h?window.trayride:window.botguard)?Lj(g,c,d,f,h):(Ej(b),qj(new T("Unable to load Botguard","from "+b)))},e)):a&&(e=Hc(document,"SCRIPT"),e.textContent=a,e.nonce=Fa(),document.head.appendChild(e),document.head.removeChild(e),((a=a.includes("trayride"))?window.trayride:window.botguard)?Lj(this,c,d,f,a):qj(Error("Unable to load Botguard from JS")))};
...
Md:74614,Nd:64502,Od:74615,Pd:74616,Qd:74617,Rd:77820,Sd:74618,Td:93278,Ud:93274,Vd:93275,Wd:93276,Xd:22110,Yd:29433,be:82047,ce:113550,de:75836,ee:75837,ge:42352,he:84512,ie:76065,je:75989,ke:16623,le:32594,me:27240,ne:32633,oe:74858,qe:3945,pe:16989,re:45520,se:25488,te:25492,ue:25494,we:55760,xe:14057,ye:18451,ze:57204,Ae:57203,Be:17897,Ce:57205,De:18198,Ee:17898,Fe:17909,Ge:43980,He:46220,Ie:11721,Je:49954,Ke:96369,Me:56251,Ne:25624,Oe:16906,Pe:99999,Qe:68172,Re:27068,Se:47973,Te:72773,Ue:26970,
Ve:26971,We:96805,Xe:17752,Ye:73233,Ze:109512,af:22256,bf:14115,cf:22696,df:89278,ef:89277,ff:109513,gf:43278,hf:43459,jf:43464,kf:89279,lf:43717,mf:55764,nf:22255,pf:89281,qf:40963,rf:43277,sf:43442,tf:91824,uf:120137,vf:96367,wf:36850,xf:72694,yf:37414,zf:36851,Af:73491,Bf:54473,Cf:43375,Df:46674,Ef:32473,Ff:72901,Gf:72906,Hf:50947,If:50612,Jf:50613,Kf:50942,Lf:84938,Mf:84943,Nf:84939,Of:84941,Pf:84944,Qf:84940,Rf:84942,Sf:35585,Tf:51926,Uf:79983,Vf:63238,Wf:18921,Xf:63241,Yf:57893,Zf:41182,ag:33424,
cg:22207,eg:36229,fg:22206,gg:22205,hg:18993,jg:19001,kg:18990,lg:18991,mg:18997,ng:18725,og:19003,pg:36874,qg:44763,rg:33427,sg:67793,tg:22182,ug:37091,vg:34650,wg:50617,xg:47261,yg:22287,zg:25144,Ag:97917,Bg:62397,Cg:36961,Dg:108035,Eg:27426,Fg:27857,Gg:27846,Hg:27854,Ig:69692,Jg:61411,Kg:39299,Lg:38696,Mg:62520,Ng:36382,Og:108701,Pg:50663,Qg:36387,Rg:14908,Sg:37533,Tg:105443,Ug:61635,Vg:62274,Wg:65702,Xg:65703,Yg:65701,Zg:76256,ah:37671,bh:49953,eh:36216,fh:28237,gh:39553,hh:29222,ih:26107,jh:38050,
kh:26108,mh:120745,lh:26109,nh:26110,oh:66881,ph:28236,qh:14586,rh:57929,sh:74723,uh:44098,vh:44099,wh:23528,xh:61699,yh:59149,zh:101951,Ah:97346,Bh:118051,Ch:95102,Dh:64882,Eh:119505,Fh:63595,Gh:63349,Hh:95101,Ih:75240,Jh:27039,Kh:68823,Lh:21537,Mh:83464,Nh:75707,Oh:83113,Ph:101952,Qh:101953,Sh:79610,Th:24402,Uh:24400,Vh:32925,Wh:57173,Xh:64423,Yh:64424,Zh:33986,ai:100828,bi:21409,ci:11070,di:11074,fi:17880,gi:14001,ii:30709,ji:30707,ki:30711,li:30710,mi:30708,hi:26984,ni:63648,oi:63649,ri:51879,
si:111059,ti:5754,vi:20445,wi:110386,xi:113746,yi:66557,zi:17310,Ai:28631,Bi:21589,Ci:68012,Di:60480,Ei:31571,Fi:76980,Gi:41577,Hi:45469,Ii:38669,Ji:13768,Ki:13777,Li:62985,Ni:59369,Oi:43927,Pi:43928,Qi:12924,Ri:100355,Ti:56219,Ui:27669,Vi:10337,Si:47896,Wi:107598,Xi:96639,Yi:107536,Zi:96661,aj:96658,bj:116646,cj:96660,dj:104443,ej:96659,fj:106442,gj:63667,hj:63668,ij:63669,jj:78314,kj:55761,lj:96368,mj:67374,nj:48992,oj:49956,pj:31961,qj:26388,rj:23811,sj:5E4,uj:47355,vj:47356,wj:37935,xj:45521,
yj:21760,zj:83769,Aj:49977,Bj:49974,Cj:93497,Dj:93498,Ej:34325,Fj:115803,Gj:100081,Hj:35309,Ij:68314,Jj:25602,Kj:100339,Lj:59018,Mj:18248,Nj:50625,Oj:9729,Pj:37168,Qj:37169,Rj:21667,Sj:16749,Tj:18635,Uj:39305,Vj:18046,Wj:53969,Xj:8213,Yj:93926,Zj:102852,ak:110099,bk:22678,ck:69076,ek:100856,fk:17736,gk:3832,hk:55759,ik:64031,jk:93044,kk:93045,lk:34388,mk:17657,nk:17655,pk:39579,qk:39578,rk:77448,sk:8196,tk:11357,uk:69877,vk:8197,wk:82039};function Qj(a){a=void 0===a?!1:a;L.call(this);this.h=new N(a);Rc(this,Sa(Pc,this.h))}
F(Qj,L);Qj.prototype.subscribe=function(a,b,c){return this.i?0:this.h.subscribe(a,b,c)};
Qj.prototype.l=function(a,b){this.i||this.h.O.apply(this.h,arguments)};function Rj(a,b,c){Qj.call(this);this.j=a;this.destination=b;this.id=c}
v(Rj,Qj);Rj.prototype.P=function(a,b){this.i||this.j.P(this.destination,this.id,a,b)};
Rj.prototype.A=function(){this.destination=this.j=null;Qj.prototype.A.call(this)};function Sj(a){L.call(this);this.h=a;this.h.subscribe("command",this.Da,this);this.j={};this.m=!1}
v(Sj,L);m=Sj.prototype;m.start=function(){this.m||this.i||(this.m=!0,this.h.P("RECEIVING"))};
m.P=function(a,b){this.m&&!this.i&&this.h.P(a,b)};
m.Da=function(a,b,c){if(this.m&&!this.i){var d=b||{};switch(a){case "addEventListener":"string"===typeof d.event&&(a=d.event,a in this.j||(c=C(this.kb,this,a),this.j[a]=c,this.addEventListener(a,c)));break;case "removeEventListener":"string"===typeof d.event&&Tj(this,d.event);break;default:this.l.isReady()&&this.l.isExternalMethodAvailable(a,c||null)&&(b=Uj(a,b||{}),c=this.l.handleExternalCall(a,b,c||null),(c=Vj(a,c))&&this.P(a,c))}}};
m.kb=function(a,b){this.m&&!this.i&&this.h.P(a,this.na(a,b))};
m.na=function(a,b){if(null!=b)return{value:b}};
function Tj(a,b){b in a.j&&(a.removeEventListener(b,a.j[b]),delete a.j[b])}
m.A=function(){var a=this.h;a.i||cf(a.h,"command",this.Da,this);this.h=null;for(var b in this.j)Tj(this,b);L.prototype.A.call(this)};function Wj(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
...
function Zj(a,b,c,d){if(B(a)&&!Array.isArray(a)){b="playlist list listType index startSeconds suggestedQuality".split(" ");c={};for(d=0;d<b.length;d++){var e=b[d];a[e]&&(c[e]=a[e])}return c}b={index:b,startSeconds:c,suggestedQuality:d};"string"===typeof a&&16===a.length?b.list="PL"+a:b.playlist=a;return b}
;function ak(a,b){Sj.call(this,b);this.l=a;this.start()}
v(ak,Sj);ak.prototype.addEventListener=function(a,b){this.l.addEventListener(a,b)};
ak.prototype.removeEventListener=function(a,b){this.l.removeEventListener(a,b)};
function Uj(a,b){switch(a){case "loadVideoById":return b=Yj(b),[b];case "cueVideoById":return b=Yj(b),[b];case "loadVideoByPlayerVars":return[b];case "cueVideoByPlayerVars":return[b];case "loadPlaylist":return b=Zj(b),[b];case "cuePlaylist":return b=Zj(b),[b];case "seekTo":return[b.seconds,b.allowSeekAhead];case "playVideoAt":return[b.index];case "setVolume":return[b.volume];case "setPlaybackQuality":return[b.suggestedQuality];case "setPlaybackRate":return[b.suggestedRate];case "setLoop":return[b.loopPlaylists];
...
ak.prototype.na=function(a,b){switch(a){case "onReady":return;case "onStateChange":return{playerState:b};case "onPlaybackQualityChange":return{playbackQuality:b};case "onPlaybackRateChange":return{playbackRate:b};case "onError":return{errorCode:b}}return Sj.prototype.na.call(this,a,b)};
ak.prototype.A=function(){Sj.prototype.A.call(this);delete this.l};function bk(a,b,c){L.call(this);var d=this;c=c||H("POST_MESSAGE_ORIGIN",void 0)||window.document.location.protocol+"//"+window.document.location.hostname;this.j=b||null;this.B="*";this.l=c;this.sessionId=null;this.channel="widget";this.G=!!a;this.u=function(e){a:if(!("*"!=d.l&&e.origin!=d.l||d.j&&e.source!=d.j||"string"!==typeof e.data)){try{var f=JSON.parse(e.data)}catch(g){break a}if(!(null==f||d.G&&(d.sessionId&&d.sessionId!=f.id||d.channel&&d.channel!=f.channel))&&f)switch(f.event){case "listening":"null"!=
...
v(bk,L);bk.prototype.sendMessage=function(a,b){var c=b||this.j;if(c){this.sessionId&&(a.id=this.sessionId);this.channel&&(a.channel=this.channel);try{var d=JSON.stringify(a);c.postMessage(d,this.B)}catch(e){Af(e)}}};
bk.prototype.A=function(){window.removeEventListener("message",this.u);L.prototype.A.call(this)};function ck(){var a=this.i=new bk(!!H("WIDGET_ID_ENFORCE")),b=C(this.hb,this);a.m=b;a.o=null;this.i.channel="widget";if(a=H("WIDGET_ID"))this.i.sessionId=a;this.l=[];this.o=!1;this.m={}}
m=ck.prototype;m.hb=function(a,b,c){"addEventListener"==a&&b?(a=b[0],this.m[a]||"onReady"==a||(this.addEventListener(a,dk(this,a)),this.m[a]=!0)):this.ta(a,b,c)};
m.ta=function(){};
function dk(a,b){return C(function(c){this.sendMessage(b,c)},a)}
m.addEventListener=function(){};
m.Ma=function(){this.o=!0;this.sendMessage("initialDelivery",this.oa());this.sendMessage("onReady");G(this.l,this.Ea,this);this.l=[]};
m.oa=function(){return null};
function ek(a,b){a.sendMessage("infoDelivery",b)}
m.Ea=function(a){this.o?this.i.sendMessage(a):this.l.push(a)};
m.sendMessage=function(a,b){this.Ea({event:a,info:void 0==b?null:b})};
m.dispose=function(){this.i=null};function fk(a){ck.call(this);this.h=a;this.j=[];this.addEventListener("onReady",C(this.eb,this));this.addEventListener("onVideoProgress",C(this.ob,this));this.addEventListener("onVolumeChange",C(this.pb,this));this.addEventListener("onApiChange",C(this.jb,this));this.addEventListener("onPlaybackQualityChange",C(this.lb,this));this.addEventListener("onPlaybackRateChange",C(this.mb,this));this.addEventListener("onStateChange",C(this.nb,this));this.addEventListener("onWebglSettingsChanged",C(this.qb,
this))}
v(fk,ck);m=fk.prototype;m.ta=function(a,b,c){if(this.h.isExternalMethodAvailable(a,c)){b=b||[];if(0<b.length&&Wj(a)){var d=b;if(B(d[0])&&!Array.isArray(d[0]))d=d[0];else{var e={};switch(a){case "loadVideoById":case "cueVideoById":e=Yj.apply(window,d);break;case "loadVideoByUrl":case "cueVideoByUrl":e=Xj.apply(window,d);break;case "loadPlaylist":case "cuePlaylist":e=Zj.apply(window,d)}d=e}b.length=1;b[0]=d}this.h.handleExternalCall(a,b,c);Wj(a)&&ek(this,this.oa())}};
m.eb=function(){var a=C(this.Ma,this);this.i.h=a};
m.addEventListener=function(a,b){this.j.push({eventType:a,listener:b});this.h.addEventListener(a,b)};
m.oa=function(){if(!this.h)return null;var a=this.h.getApiInterface();cb(a,"getVideoData");for(var b={apiInterface:a},c=0,d=a.length;c<d;c++){var e=a[c];if(0===e.search("get")||0===e.search("is")){var f=0;0===e.search("get")?f=3:0===e.search("is")&&(f=2);f=e.charAt(f).toLowerCase()+e.substr(f+1);try{var g=this.h[e]();b[f]=g}catch(h){}}}b.videoData=this.h.getVideoData();b.currentTimeLastUpdated_=E()/1E3;return b};
...
m.lb=function(a){ek(this,{playbackQuality:a})};
m.mb=function(a){ek(this,{playbackRate:a})};
...
m.pb=function(){ek(this,{muted:this.h.isMuted(),volume:this.h.getVolume()})};
...
m.qb=function(){var a={sphericalProperties:this.h.getSphericalProperties()};ek(this,a)};
m.dispose=function(){ck.prototype.dispose.call(this);for(var a=0;a<this.j.length;a++){var b=this.j[a];this.h.removeEventListener(b.eventType,b.listener)}this.j=[]};function gk(a,b,c){L.call(this);this.h=a;this.l=c;this.o=Mf(window,"message",C(this.m,this));this.j=new Rj(this,a,b);Rc(this,Sa(Pc,this.j))}
v(gk,L);gk.prototype.P=function(a,b,c,d){this.i||a!=this.h||(a={id:b,command:c},d&&(a.data=d),this.h.postMessage(Fe(a),this.l))};
gk.prototype.m=function(a){var b;if(b=!this.i)if(b=a.origin==this.l)a:{b=this.h;do{b:{var c=a.source;do{if(c==b){c=!0;break b}if(c==c.parent)break;c=c.parent}while(null!=c);c=!1}if(c){b=!0;break a}b=b.opener}while(null!=b);b=!1}if(b&&(b=a.data,"string"===typeof b)){try{b=JSON.parse(b)}catch(d){return}b.command&&(c=this.j,c.i||c.l("command",b.command,b.data,a.origin))}};
gk.prototype.A=function(){Nf(this.o);this.h=null;L.prototype.A.call(this)};function hk(){var a=mb(ik),b;return Se(new M(function(c,d){a.onSuccess=function(e){pg(e)?c(e):d(new jk("Request failed, status="+(e&&"status"in e?e.status:-1),"net.badstatus",e))};
...
b=yg("//googleads.g.doubleclick.net/pagead/id",a)}),function(c){c instanceof Te&&b.abort();
return Qe(c)})}
...
kk.prototype.then=function(a,b,c){return 1===this.i&&a?(a=a.call(c,this.h),Le(a)?a:lk(a)):2===this.i&&b?(a=b.call(c,this.h),Le(a)?a:mk(a)):this};
...
;function nk(a){Va.call(this,a.message||a.description||a.name);this.isMissing=a instanceof ok;this.isTimeout=a instanceof jk&&"net.timeout"==a.errorCode;this.isCanceled=a instanceof Te}
...
function bg(){if(P("disable_biscotti_fetch_on_html5_clients"))return Qe(Error("Fetching biscotti ID is disabled."));if(P("condition_biscotti_fetch_on_consent_cookie_html5_clients")&&!md.get("CONSENT","").startsWith("YES+"))return Qe(Error("User has not consented - not fetching biscotti id."));if("1"==kb())return Qe(Error("Biscotti ID is not available in private embed mode"));pk||(pk=Se(hk().then(qk),function(a){return rk(2,a)}));
return pk}
function qk(a){a=a.responseText;if(0!=a.lastIndexOf(")]}'",0))throw new ok;a=JSON.parse(a.substr(4));if(1<(a.type||1))throw new ok;a=a.id;cg(a);pk=lk(a);sk(18E5,2);return a}
function rk(a,b){var c=new nk(b);cg("");pk=mk(c);0<a&&sk(12E4,a-1);throw c;}
function sk(a,b){Q(function(){Se(hk().then(qk,function(c){return rk(b,c)}),Ja)},a)}
function tk(){try{var a=y("yt.ads.biscotti.getId_");return a?a():bg()}catch(b){return Qe(b)}}
;function uk(a){if("1"!=kb()){a&&ag();try{tk().then(function(){},function(){}),Q(uk,18E5)}catch(b){zf(b)}}}
;var vk=E().toString();
function wk(){a:{if(window.crypto&&window.crypto.getRandomValues)try{var a=Array(16),b=new Uint8Array(16);window.crypto.getRandomValues(b);for(var c=0;c<a.length;c++)a[c]=b[c];var d=a;break a}catch(e){}d=Array(16);for(a=0;16>a;a++){b=E();for(c=0;c<b%23;c++)d[a]=Math.random();d[a]=Math.floor(256*Math.random())}if(vk)for(a=1,b=0;b<vk.length;b++)d[a%16]=d[a%16]^d[(a-1)%16]/4^vk.charCodeAt(b),a++}a=[];for(b=0;b<d.length;b++)a.push("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789-_".charAt(d[b]&63));
return a.join("")}
;var xk=w.ytLoggingDocDocumentNonce_||wk();x("ytLoggingDocDocumentNonce_",xk,void 0);var yk={Zd:0,ac:1,kc:2,dh:3,ae:4,dk:5,Rh:6,0:"DEFAULT",1:"CHAT",2:"CONVERSATIONS",3:"MINIPLAYER",4:"DIALOG",5:"VOZ",6:"MUSIC_WATCH_TABS"};function zk(a){this.h=a}
function Ak(a){return new zk({trackingParams:a})}
zk.prototype.getAsJson=function(){var a={};void 0!==this.h.trackingParams?a.trackingParams=this.h.trackingParams:(a.veType=this.h.veType,void 0!==this.h.veCounter&&(a.veCounter=this.h.veCounter),void 0!==this.h.elementIndex&&(a.elementIndex=this.h.elementIndex));void 0!==this.h.dataElement&&(a.dataElement=this.h.dataElement.getAsJson());void 0!==this.h.youtubeData&&(a.youtubeData=this.h.youtubeData);return a};
zk.prototype.toString=function(){return JSON.stringify(this.getAsJson())};
zk.prototype.isClientVe=function(){return!this.h.trackingParams&&!!this.h.veType};function Bk(a){a=void 0===a?0:a;return 0==a?"client-screen-nonce":"client-screen-nonce."+a}
function Ck(a){a=void 0===a?0:a;return 0==a?"ROOT_VE_TYPE":"ROOT_VE_TYPE."+a}
function Dk(a){return H(Ck(void 0===a?0:a),void 0)}
x("yt_logging_screen.getRootVeType",Dk,void 0);function Ek(a){return(a=Dk(void 0===a?0:a))?new zk({veType:a,youtubeData:void 0}):null}
function Fk(){var a=H("csn-to-ctt-auth-info");a||(a={},O("csn-to-ctt-auth-info",a));return a}
function Gk(a){a=void 0===a?0:a;var b=H(Bk(a));if(!b&&!H("USE_CSN_FALLBACK",!0))return null;b||0!=a||(b="UNDEFINED_CSN");return b?b:null}
x("yt_logging_screen.getCurrentCsn",Gk,void 0);function Hk(a,b,c){var d=Fk();(c=Gk(c))&&delete d[c];b&&(d[a]=b)}
function Ik(a){return Fk()[a]}
x("yt_logging_screen.getCttAuthInfo",Ik,void 0);function Jk(a,b,c,d){c=void 0===c?0:c;if(a!==H(Bk(c))||b!==H(Ck(c)))Hk(a,d,c),O(Bk(c),a),O(Ck(c),b),b=function(){setTimeout(function(){a&&th("foregroundHeartbeatScreenAssociated",{clientDocumentNonce:xk,clientScreenNonce:a},$i)},0)},"requestAnimationFrame"in window?window.requestAnimationFrame(b):b()}
x("yt_logging_screen.setCurrentScreen",Jk,void 0);function Kk(a){Jh.call(this,1,arguments);this.csn=a}
v(Kk,Jh);var Sh=new Kh("screen-created",Kk),Lk=[],Nk=Mk,Ok=0;function Pk(a,b,c,d){c={csn:b,parentVe:c.getAsJson(),childVes:$a(d,function(f){return f.getAsJson()})};
d=u(d);for(var e=d.next();!e.done;e=d.next())e=e.value.getAsJson(),(ib(e)||!e.trackingParams&&!e.veType)&&qj(Error("Child VE logged with no data"));d={C:Ik(b),M:b};"UNDEFINED_CSN"==b?Qk("visualElementAttached",c,d):a?th("visualElementAttached",c,a,d):X("visualElementAttached",c,d)}
function Mk(){for(var a=Math.random()+"",b=[],c=0,d=0;d<a.length;d++){var e=a.charCodeAt(d);255<e&&(b[c++]=e&255,e>>=8);b[c++]=e}return zc(b)}
function Qk(a,b,c){Lk.push({payloadName:a,payload:b,options:c});Ok||(Ok=Th())}
function Uh(a){if(Lk){for(var b=u(Lk),c=b.next();!c.done;c=b.next())c=c.value,c.payload&&(c.payload.csn=a.csn,th(c.payloadName,c.payload,null,c.options));Lk.length=0}Ok=0}
;function Rk(){this.i=new Set;this.h=new Set;this.j=new Map}
Rk.prototype.clear=function(){this.i.clear();this.h.clear();this.j.clear()};
Ka(Rk);function Sk(a,b){for(var c=[],d=1;d<arguments.length;++d)c[d-1]=arguments[d];if(!Tk(a)||c.some(function(e){return!Tk(e)}))throw Error("Only objects may be merged.");
c=u(c);for(d=c.next();!d.done;d=c.next())Uk(a,d.value);return a}
...
function Wk(a,b){for(var c=u(b),d=c.next();!d.done;d=c.next())d=d.value,Tk(d)?a.push(Uk({},d)):Vk(d)?a.push(Wk([],d)):a.push(d);return a}
function Tk(a){return"object"===typeof a&&!Array.isArray(a)}
function Vk(a){return"object"===typeof a&&Array.isArray(a)}
;function Xk(a,b){Jh.call(this,1,arguments)}
v(Xk,Jh);function Yk(a,b){Jh.call(this,1,arguments)}
v(Yk,Jh);var Zk=new Kh("aft-recorded",Xk),$k=new Kh("timing-sent",Yk);var al=window;function bl(){this.timing={};this.clearResourceTimings=function(){};
this.webkitClearResourceTimings=function(){};
this.mozClearResourceTimings=function(){};
this.msClearResourceTimings=function(){};
this.oClearResourceTimings=function(){}}
var cl=al.performance||al.mozPerformance||al.msPerformance||al.webkitPerformance||new bl;var dl=!1;C(cl.clearResourceTimings||cl.webkitClearResourceTimings||cl.mozClearResourceTimings||cl.msClearResourceTimings||cl.oClearResourceTimings||Ja,cl);function el(a){var b=fl(a);if(b.aft)return b.aft;a=H((a||"")+"TIMING_AFT_KEYS",["ol"]);for(var c=a.length,d=0;d<c;d++){var e=b[a[d]];if(e)return e}return NaN}
function gl(a){var b;(b=y("ytcsi."+(a||"")+"data_"))||(b={tick:{},info:{}},Ta("ytcsi."+(a||"")+"data_",b));return b}
function hl(a){a=gl(a);a.info||(a.info={});return a.info}
function fl(a){a=gl(a);a.tick||(a.tick={});return a.tick}
function il(a){var b=gl(a).nonce;b||(b=wk(),gl(a).nonce=b);return b}
function jl(a){var b=fl(a||""),c=el(a);c&&!dl&&(Ph(Zk,new Xk(Math.round(c-b._start),a)),dl=!0)}
...
;var ml=w.ytLoggingLatencyUsageStats_||{};x("ytLoggingLatencyUsageStats_",ml,void 0);function nl(){this.h=0}
function ol(){nl.h||(nl.h=new nl);return nl.h}
nl.prototype.tick=function(a,b,c){pl(this,"tick_"+a+"_"+b)||X("latencyActionTicked",{tickName:a,clientActionNonce:b},{timestamp:c})};
nl.prototype.info=function(a,b){var c=Object.keys(a).join("");pl(this,"info_"+c+"_"+b)||(c=Object.assign({},a),c.clientActionNonce=b,X("latencyActionInfo",c))};
nl.prototype.span=function(a,b){var c=Object.keys(a).join("");pl(this,"span_"+c+"_"+b)||(a.clientActionNonce=b,X("latencyActionSpan",a))};
function pl(a,b){ml[b]=ml[b]||{count:0};var c=ml[b];c.count++;c.time=R();a.h||(a.h=Tf(function(){var d=R(),e;for(e in ml)ml[e]&&6E4<d-ml[e].time&&delete ml[e];a&&(a.h=0)},0,5E3));
...
"requestIds",Y.GetTrending_rid="requestIds",Y.GetMusicSearchSuggestions_rid="requestIds",Y.REQUEST_ID="requestIds",Y),rl="isContinuation isNavigation kabukiInfo.earlyBrowseRequestInfo.adopted kabukiInfo.isPrefetch kabukiInfo.isSecondaryNav isMonetized navigationRequestedSameUrl performanceNavigationTiming playerInfo.isPausedOnLoad prerollAllowed isRedSubscriber tvInfo.isMdx tvInfo.isPreloaded isVisible watchInfo.isPlaylist playbackRequiresTap".split(" "),sl={},tl=(sl.ccs="CANARY_STATE_",sl.mver="MEASUREMENT_VERSION_",
sl.pis="PLAYER_INITIALIZED_STATE_",sl.yt_pt="LATENCY_PLAYER_",sl.pa="LATENCY_ACTION_",sl.yt_vst="VIDEO_STREAM_TYPE_",sl),ul="all_vc ap aq c cver cbrand cmodel cplatform ctheme ei l_an l_mm plid srt yt_fss yt_li vpst vpni2 vpil2 icrc icrt pa GetAccountOverview_rid GetHistory_rid cmt d_vpct d_vpnfi d_vpni nsru pc pfa pfeh pftr pnc prerender psc rc start tcrt tcrc ssr vpr vps yt_abt yt_fn yt_fs yt_pft yt_pre yt_pt yt_pvis ytu_pvis yt_ref yt_sts tds".split(" ");
function vl(a){return!!H("FORCE_CSI_ON_GEL",!1)||P("csi_on_gel")||!!gl(a).useGel}
function wl(a){a=gl(a);if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}else a.gel={gelTicks:{},gelInfos:{}};return a.gel}
;function xl(a,b,c){if(null!==b)if(hl(c)[a]=b,vl(c)){var d=b;b=wl(c);if(b.gelInfos)b.gelInfos["info_"+a]=!0;else{var e={};b.gelInfos=(e["info_"+a]=!0,e)}if(a.match("_rid")){var f=a.split("_rid")[0];a="REQUEST_ID"}if(a in ql){b=ql[a];0<=Ya(rl,b)&&(d=!!d);a in tl&&"string"===typeof d&&(d=tl[a]+d.toUpperCase());a=d;d=b.split(".");for(var g=e={},h=0;h<d.length-1;h++){var k=d[h];g[k]={};g=g[k]}g[d[d.length-1]]="requestIds"===b?[{id:a,endpoint:f}]:a;f=Sk({},e)}else 0<=Ya(ul,a)||qj(new T("Unknown label logged with GEL CSI",
a)),f=void 0;f&&vl(c)&&(b=ll(c||""),Sk(b.info,f),b=wl(c),b.gelInfos||(b.gelInfos={}),Sk(b.gelInfos,f),c=il(c),ol().info(f,c))}else ll(c||"").info[a]=b}
function yl(a,b,c){var d=fl(c);if(P("use_first_tick")&&zl(a,c))return d[a];if(!b&&"_"!==a[0]){var e=a;cl.mark&&(0==e.lastIndexOf("mark_",0)||(e="mark_"+e),c&&(e+=" ("+c+")"),cl.mark(e))}e=b||R();d[a]=e;e=wl(c);e.gelTicks&&(e.gelTicks["tick_"+a]=!0);c||b||R();if(vl(c)){ll(c||"").tick[a]=b||R();e=il(c);if("_start"===a){var f=ol();pl(f,"baseline_"+e)||X("latencyActionBaselined",{clientActionNonce:e},{timestamp:b})}else ol().tick(a,e,b);jl(c);e=!0}else e=!1;if(!e){if(!y("yt.timing."+(c||"")+"pingSent_")&&
(f=H((c||"")+"TIMING_ACTION",void 0),e=fl(c),y("ytglobal.timing"+(c||"")+"ready_")&&f&&zl("_start")&&el(c)))if(jl(c),c)Al(c);else{f=!0;var g=H("TIMING_WAIT",[]);if(g.length)for(var h=0,k=g.length;h<k;++h)if(!(g[h]in e)){f=!1;break}f&&Al(c)}ll(c||"").tick[a]=b||R()}return d[a]}
function zl(a,b){var c=fl(b);return a in c}
function Al(a){if(!vl(a)){var b=fl(a),c=hl(a),d=b._start,e=H("CSI_SERVICE_NAME","youtube"),f={v:2,s:e,action:H((a||"")+"TIMING_ACTION",void 0)},g=c.srt;void 0!==b.srt&&delete c.srt;b.aft=el(a);var h=fl(a),k=h.pbr,l=h.vc;h=h.pbs;k&&l&&h&&k<l&&l<h&&hl(a).yt_pvis&&"youtube"===e&&(xl("yt_lt","hot_bg",a),e=b.vc,k=b.pbs,delete b.aft,c.aft=Math.round(k-e));for(var n in c)"_"!==n.charAt(0)&&(f[n]=c[n]);b.ps=R();n={};e=[];for(var p in b)"_"!==p.charAt(0)&&(k=Math.round(b[p]-d),n[p]=k,e.push(p+"."+k));f.rt=
e.join(",");b=!!c.ap;P("debug_csi_data")&&(c=y("yt.timing.csiData"),c||(c=[],Ta("yt.timing.csiData",c)),c.push({page:location.href,time:new Date,args:f}));c="";for(var q in f)f.hasOwnProperty(q)&&(c+="&"+q+"="+f[q]);f="/csi_204?"+c.substring(1);window.navigator&&window.navigator.sendBeacon&&(b||P("always_send_csi_204_with_beacon"))?Lg(f):Ig(f);x("yt.timing."+(a||"")+"pingSent_",!0,void 0);Ph($k,new Yk(n.aft+(Number(g)||0),a))}}
var Bl=window;Bl.ytcsi&&(Bl.ytcsi.info=xl,Bl.ytcsi.tick=yl);function Cl(){this.l=[];this.m=[];this.h=[];this.i=new Set;this.o=new Map}
function Dl(a,b,c){c=void 0===c?0:c;b.then(function(d){var e,f;a.i.has(c)&&a.j&&a.j();var g=Gk(c),h=Ek(c);g&&h&&(d.csn=g,(null===(e=d.response)||void 0===e?0:e.trackingParams)&&Pk(a.client,g,h,[Ak(d.response.trackingParams)]),(null===(f=d.playerResponse)||void 0===f?0:f.trackingParams)&&Pk(a.client,g,h,[Ak(d.playerResponse.trackingParams)]))})}
function El(a,b,c,d){d=void 0===d?0:d;if(a.i.has(d))a.l.push([b,c]);else{var e=Gk(d);c=c||Ek(d);e&&c&&Pk(a.client,e,c,[b])}}
Cl.prototype.clickCommand=function(a){var b=Gk();if(!a.clickTrackingParams||!b)return!1;var c=this.client;var d="INTERACTION_LOGGING_GESTURE_TYPE_GENERIC_CLICK";a={csn:b,ve:Ak(a.clickTrackingParams).getAsJson(),gestureType:d};d={C:Ik(b),M:b};"UNDEFINED_CSN"==b?Qk("visualElementGestured",a,d):c?th("visualElementGestured",a,c,d):X("visualElementGestured",a,d);return!0};
function Fl(a,b,c){c=void 0===c?{}:c;a.i.add(c.layer||0);a.j=function(){Gl(a,b,c);var f=Ek(c.layer);if(f){for(var g=u(a.l),h=g.next();!h.done;h=g.next())h=h.value,El(a,h[0],h[1]||f,c.layer);f=u(a.m);for(g=f.next();!g.done;g=f.next()){var k=g.value;g=void 0;g=void 0===g?0:g;h=Gk(g);var l=k[0]||Ek(g);h&&l&&(g=a.client,k=k[1],k={csn:h,ve:l.getAsJson(),clientData:k},l={C:Ik(h),M:h},"UNDEFINED_CSN"==h?Qk("visualElementStateChanged",k,l):g?th("visualElementStateChanged",k,g,l):X("visualElementStateChanged",
k,l))}}};
Gk(c.layer)||a.j();if(c.ya)for(var d=u(c.ya),e=d.next();!e.done;e=d.next())Dl(a,e.value,c.layer);else rj(Error("Delayed screen needs a data promise."))}
function Gl(a,b,c){c=void 0===c?{}:c;c.layer||(c.layer=0);var d=void 0!==c.fb?c.fb:c.layer;var e=Gk(d);d=Ek(d);var f;d&&(void 0!==c.parentCsn?f={clientScreenNonce:c.parentCsn,visualElement:d}:e&&"UNDEFINED_CSN"!==e&&(f={clientScreenNonce:e,visualElement:d}));try{var g=a.client,h=f,k=c.xa,l=c.C,n=Nk(),p={csn:n,pageVe:(new zk({veType:b,youtubeData:void 0})).getAsJson()};h&&h.visualElement?p.implicitGesture={parentCsn:h.clientScreenNonce,gesturedVe:h.visualElement.getAsJson()}:h&&qj(new T("newScreen() parent element does not have a VE - rootVe",
b));k&&(p.cloneCsn=k);k={C:l,M:n};g?th("screenCreated",p,g,k):X("screenCreated",p,k);Ph(Sh,new Kk(n));var q=n}catch(r){sj(r,{Hk:b,rootVe:d,parentVisualElement:void 0,Bk:e,Gk:f,xa:c.xa});rj(r);return}Jk(q,b,c.layer,c.C);if((b=e&&"UNDEFINED_CSN"!==e&&d)&&!(b=P("screen_manager_skip_hide_killswitch"))){a:{b=u(Object.values(yk));for(f=b.next();!f.done;f=b.next())if(Gk(f.value)==e){b=!0;break a}b=!1}b=!b}b&&(b=a.client,f=!0,g=(f=void 0===f?!1:f)?16:8,d={csn:e,ve:d.getAsJson(),eventType:g},f={C:Ik(e),M:e,
La:f},"UNDEFINED_CSN"==e?Qk("visualElementHidden",d,f):b?th("visualElementHidden",d,b,f):X("visualElementHidden",d,f));a.h[a.h.length-1]&&!a.h[a.h.length-1].csn&&(a.h[a.h.length-1].csn=q||"");xl("csn",q);Rk.getInstance().clear();d=Ek(c.layer);e&&"UNDEFINED_CSN"!==e&&d&&(P("web_mark_root_visible")||P("music_web_mark_root_visible"))&&(e=q,q=P("use_default_events_client")?void 0:$i,b={csn:e,ve:d.getAsJson(),eventType:1},f={C:Ik(e),M:e},"UNDEFINED_CSN"==e?Qk("visualElementShown",b,f):q?th("visualElementShown",
b,q,f):X("visualElementShown",b,f));a.i["delete"](c.layer||0);a.j=void 0;e=u(a.o);for(q=e.next();!q.done;q=e.next())q=u(q.value),b=q.next().value,q.next().value.has(c.layer)&&d&&El(a,b,d,c.layer)}
;function Hl(){L.call(this);this.h=[]}
v(Hl,L);Hl.prototype.A=function(){for(;this.h.length;){var a=this.h.pop();a.target.removeEventListener(a.name,a.Ja)}L.prototype.A.call(this)};function Il(a){a=a||{};var b={},c={};this.url=a.url||"";this.args=a.args||mb(b);this.assets=a.assets||{};this.attrs=a.attrs||mb(c);this.fallback=a.fallback||null;this.fallbackMessage=a.fallbackMessage||null;this.html5=!!a.html5;this.disable=a.disable||{};this.loaded=!!a.loaded;this.messages=a.messages||{}}
Il.prototype.clone=function(){var a=new Il,b;for(b in this)if(this.hasOwnProperty(b)){var c=this[b];"object"==La(c)?a[b]=mb(c):a[b]=c}return a};var Jl=/cssbin\/(?:debug-)?([a-zA-Z0-9_-]+?)(?:-2x|-web|-rtl|-vfl|.css)/;function Kl(a){a=a||"";if(window.spf){var b=a.match(Jl);spf.style.load(a,b?b[1]:"",void 0)}else Ll(a)}
function Ll(a){var b=Ml(a),c=document.getElementById(b),d=c&&vj(c,"loaded");d||c&&!d||(c=Nl(a,b,function(){vj(c,"loaded")||(tj(c),Tg(b),Q(Sa(Ug,b),0))}))}
...
function Ml(a){var b=Hc(document,"A");Rb(b,new I(a,Eb));a=b.href.replace(/^[a-zA-Z]+:\/\//,"//");return"css-"+Ub(a)}
;function Ol(a,b,c,d){L.call(this);var e=this;this.u=this.da=a;this.J=b;this.B=!1;this.api={};this.ba=this.I=null;this.K=new N;Rc(this,Sa(Pc,this.K));this.m={};this.T=this.ca=this.l=this.la=this.h=null;this.S=!1;this.o=this.G=null;this.ea={};this.Ga=["onReady"];this.ka=null;this.va=NaN;this.Z={};this.j=d;Pl(this);this.fa("WATCH_LATER_VIDEO_ADDED",this.bb.bind(this));this.fa("WATCH_LATER_VIDEO_REMOVED",this.cb.bind(this));this.fa("onAdAnnounce",this.Ia.bind(this));this.Ha=new Hl(this);Rc(this,Sa(Pc,
this.Ha));this.aa=0;c?this.aa=Q(function(){e.loadNewVideoConfig(c)},0):d&&(Ql(this),Rl(this))}
v(Ol,L);m=Ol.prototype;m.getId=function(){return this.J};
m.loadNewVideoConfig=function(a){if(!this.i){this.aa&&(Pf(this.aa),this.aa=0);a instanceof Il||(a=new Il(a));this.la=a;this.h=a.clone();Ql(this);this.ca||(this.ca=Sl(this,this.h.args.jsapicallback||"onYouTubePlayerReady"));this.h.args.jsapicallback=null;if(a=this.h.attrs.width)this.u.style.width=gd(Number(a)||String(a));if(a=this.h.attrs.height)this.u.style.height=gd(Number(a)||String(a));Rl(this);this.B&&Tl(this)}};
function Ql(a){var b;a.j?b=a.j.rootElementId:b=a.h.attrs.id;a.l=b||a.l;"video-player"==a.l&&(a.l=a.J,a.j?a.j.rootElementId=a.J:a.h.attrs.id=a.J);a.u.id==a.l&&(a.l+="-player",a.j?a.j.rootElementId=a.l:a.h.attrs.id=a.l)}
m.Na=function(){return this.la};
function Tl(a){a.h&&!a.h.loaded&&(a.h.loaded=!0,"0"!=a.h.args.autoplay?a.api.loadVideoByPlayerVars(a.h.args):a.api.cueVideoByPlayerVars(a.h.args))}
function Ul(a){var b=!0,c=Vl(a);c&&a.h&&(a=Wl(a),b=vj(c,"version")===a);return b&&!!y("yt.player.Application.create")}
function Rl(a){if(!a.i&&!a.S){var b=Ul(a);if(b&&"html5"==(Vl(a)?"html5":null))a.T="html5",a.B||Xl(a);else if(Yl(a),a.T="html5",b&&a.o)a.da.appendChild(a.o),Xl(a);else{a.h&&(a.h.loaded=!0);var c=!1;a.G=function(){c=!0;var d=Zl(a,"player_bootstrap_method")?y("yt.player.Application.createAlternate")||y("yt.player.Application.create"):y("yt.player.Application.create");var e=a.h?a.h.clone():void 0;d(a.da,e,a.j);Xl(a)};
a.S=!0;b?a.G():(zj(Wl(a),a.G),(b=a.j?a.j.cssUrl:a.h.assets.css)&&Kl(b),$l(a)&&!c&&x("yt.player.Application.create",null,void 0))}}}
function Vl(a){var b=Dc(a.l);!b&&a.u&&a.u.querySelector&&(b=a.u.querySelector("#"+a.l));return b}
function Xl(a){if(!a.i){var b=Vl(a),c=!1;b&&b.getApiInterface&&b.getApiInterface()&&(c=!0);c?(a.S=!1,!Zl(a,"html5_remove_not_servable_check_killswitch")&&b.isNotServable&&a.h&&b.isNotServable(a.h.args.video_id)||am(a)):a.va=Q(function(){Xl(a)},50)}}
function am(a){Pl(a);a.B=!0;var b=Vl(a);b.addEventListener&&(a.I=bm(a,b,"addEventListener"));b.removeEventListener&&(a.ba=bm(a,b,"removeEventListener"));var c=b.getApiInterface();c=c.concat(b.getInternalApiInterface());for(var d=0;d<c.length;d++){var e=c[d];a.api[e]||(a.api[e]=bm(a,b,e))}for(var f in a.m)a.I(f,a.m[f]);Tl(a);a.ca&&a.ca(a.api);a.K.O("onReady",a.api)}
function bm(a,b,c){var d=b[c];return function(){try{return a.ka=null,d.apply(b,arguments)}catch(e){"sendAbandonmentPing"!=c&&(e.params=c,a.ka=e,Af(e))}}}
function Pl(a){a.B=!1;if(a.ba)for(var b in a.m)a.ba(b,a.m[b]);for(var c in a.Z)Pf(parseInt(c,10));a.Z={};a.I=null;a.ba=null;for(var d in a.api)a.api[d]=null;a.api.addEventListener=a.fa.bind(a);a.api.removeEventListener=a.ib.bind(a);a.api.destroy=a.dispose.bind(a);a.api.getLastError=a.Oa.bind(a);a.api.getPlayerType=a.Pa.bind(a);a.api.getCurrentVideoConfig=a.Na.bind(a);a.api.loadNewVideoConfig=a.loadNewVideoConfig.bind(a);a.api.isReady=a.Fa.bind(a)}
m.Fa=function(){return this.B};
m.fa=function(a,b){var c=this,d=Sl(this,b);if(d){if(!(0<=Ya(this.Ga,a)||this.m[a])){var e=cm(this,a);this.I&&this.I(a,e)}this.K.subscribe(a,d);"onReady"==a&&this.B&&Q(function(){d(c.api)},0)}};
m.ib=function(a,b){if(!this.i){var c=Sl(this,b);c&&cf(this.K,a,c)}};
function Sl(a,b){var c=b;if("string"==typeof b){if(a.ea[b])return a.ea[b];c=function(){var d=y(b);d&&d.apply(w,arguments)};
a.ea[b]=c}return c?c:null}
function cm(a,b){var c="ytPlayer"+b+a.J;a.m[b]=c;w[c]=function(d){var e=Q(function(){if(!a.i){a.K.O(b,d);var f=a.Z,g=String(e);g in f&&delete f[g]}},0);
jb(a.Z,String(e))};
return c}
m.Ia=function(a){Tg("a11y-announce",a)};
m.bb=function(a){Tg("WATCH_LATER_VIDEO_ADDED",a)};
m.cb=function(a){Tg("WATCH_LATER_VIDEO_REMOVED",a)};
m.Pa=function(){return this.T||(Vl(this)?"html5":null)};
m.Oa=function(){return this.ka};
function Yl(a){a.cancel();Pl(a);a.T=null;a.h&&(a.h.loaded=!1);var b=Vl(a);b&&(Ul(a)||!$l(a)?a.o=b:(b&&b.destroy&&b.destroy(),a.o=null));for(a=a.da;b=a.firstChild;)a.removeChild(b)}
m.cancel=function(){this.G&&Fj(Wl(this),this.G);Pf(this.va);this.S=!1};
m.A=function(){Yl(this);if(this.o&&this.h&&this.o.destroy)try{this.o.destroy()}catch(b){zf(b)}this.ea=null;for(var a in this.m)w[this.m[a]]=null;this.la=this.h=this.api=null;delete this.da;delete this.u;L.prototype.A.call(this)};
function $l(a){return a.h&&a.h.args&&a.h.args.fflags?-1!=a.h.args.fflags.indexOf("player_destroy_old_version=true"):!1}
function Wl(a){return a.j?a.j.jsUrl:a.h.assets.js}
function Zl(a,b){if(a.j)var c=a.j.serializedExperimentFlags;else a.h&&a.h.args&&(c=a.h.args.fflags);return"true"==fg(c||"","&")[b]}
;var dm={},em="player_uid_"+(1E9*Math.random()>>>0);function fm(a,b,c){var d="player";c=void 0===c?!0:c;d="string"===typeof d?Dc(d):d;var e=em+"_"+Na(d),f=dm[e];if(f&&c)return gm(a,b)?f.api.loadVideoByPlayerVars(a.args||null):f.loadNewVideoConfig(a),f.api;f=new Ol(d,e,a,b);dm[e]=f;Tg("player-added",f.api);Rc(f,function(){delete dm[f.getId()]});
return f.api}
function gm(a,b){return b&&b.serializedExperimentFlags?b.serializedExperimentFlags.includes("web_player_remove_playerproxy=true"):a&&a.args&&a.args.fflags?a.args.fflags.includes("web_player_remove_playerproxy=true"):!1}
;var Z=null,hm=null,im=null;function jm(){var a=Z.getVideoData(1);a=a.title?a.title+" - YouTube":"YouTube";document.title!==a&&(document.title=a)}
;function km(a,b,c){b=void 0===b?{}:b;c=void 0===c?!1:c;var d=H("EVENT_ID");d&&(b.ei||(b.ei=d));if(b){d=a;var e=void 0===e?!0:e;var f=H("VALID_SESSION_TEMPDATA_DOMAINS",[]),g=Xb(window.location.href);g&&f.push(g);g=Xb(d);if(0<=Ya(f,g)||!g&&0==d.lastIndexOf("/",0))if(P("autoescape_tempdata_url")&&(f=document.createElement("a"),Rb(f,d),d=f.href),d){g=d.match(Vb);d=g[5];f=g[6];g=g[7];var h="";d&&(h+=d);f&&(h+="?"+f);g&&(h+="#"+g);d=h;f=d.indexOf("#");if(d=0>f?d:d.substr(0,f))if(e&&!b.csn&&(b.itct||b.ved)&&
(b=Object.assign({csn:Gk()},b)),k){var k=parseInt(k,10);isFinite(k)&&0<k&&(e=b,b="ST-"+Ub(d).toString(36),e=e?Zb(e):"",uh(b,e,k||5))}else k=b,e="ST-"+Ub(d).toString(36),k=k?Zb(k):"",uh(e,k,5)}}if(c)return!1;if((window.ytspf||{}).enabled)spf.navigate(a);else{var l=void 0===l?{}:l;var n=void 0===n?"":n;var p=void 0===p?window:p;c=p.location;a=$b(a,l)+n;a=a instanceof I?a:Jb(a);c.href=Fb(a)}return!0}
;x("yt.setConfig",O,void 0);x("yt.config.set",O,void 0);x("yt.setMsg",Cf,void 0);x("yt.msgs.set",Cf,void 0);x("yt.logging.errors.log",rj,void 0);
x("writeEmbed",function(){var a=H("PLAYER_CONFIG",void 0);if(!a){var b=H("PLAYER_VARS",void 0);b&&(a={args:b})}uk(!0);"gvn"===a.args.ps&&(document.body.style.backgroundColor="transparent");a.attrs||(a.attrs={width:"100%",height:"100%",id:"video-player"});var c=document.referrer;b=H("POST_MESSAGE_ORIGIN");window!==window.top&&c&&c!==document.URL&&(a.args.loaderUrl=c);if((c=H("WEB_PLAYER_CONTEXT_CONFIGS",void 0))&&"WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER"in c){c=c.WEB_PLAYER_CONTEXT_CONFIG_ID_EMBEDDED_PLAYER;
if(!c.serializedForcedExperimentIds){var d=window.location.href;-1!=d.indexOf("?")?(d=(d||"").split("#")[0],d=d.split("?",2),d=jg(1<d.length?d[1]:d[0])):d={};d.forced_experiments&&(c.serializedForcedExperimentIds=d.forced_experiments)}Z=fm(a,c,!1)}else Z=fm(a);Z.addEventListener("onVideoDataChange",jm);a=H("POST_MESSAGE_ID","player");H("ENABLE_JS_API")?im=new fk(Z):H("ENABLE_POST_API")&&"string"===typeof a&&"string"===typeof b&&(hm=new gk(window.parent,a,b),im=new ak(Z,hm.j));Ij()},void 0);
var lm=yf(function(){yl("ol");var a=vh.getInstance(),b=!!((yh("f"+(Math.floor(119/31)+1))||0)&67108864),c=1<window.devicePixelRatio;if(document.body&&Sd(document.body,"exp-invert-logo"))if(c&&!Sd(document.body,"inverted-hdpi")){var d=document.body;if(d.classList)d.classList.add("inverted-hdpi");else if(!Sd(d,"inverted-hdpi")){var e=Qd(d);Rd(d,e+(0<e.length?" inverted-hdpi":"inverted-hdpi"))}}else!c&&Sd(document.body,"inverted-hdpi")&&Td();b!=c&&(b="f"+(Math.floor(119/31)+1),d=yh(b)||0,d=c?d|67108864:
d&-67108865,0==d?delete S[b]:(c=d.toString(16),S[b]=c.toString()),a.save());Cl.h||(Cl.h=new Cl);a=Cl.h;c=16623;var f=void 0===f?{}:f;Object.values(Pj).includes(c)||(qj(new T("createClientScreen() called with a non-page VE",c)),c=83769);f.isHistoryNavigation||a.h.push({rootVe:c,key:f.key||""});a.l=[];a.m=[];f.ya?Fl(a,c,f):Gl(a,c,f)}),mm=yf(function(){Z&&Z.sendAbandonmentPing&&Z.sendAbandonmentPing();
H("PL_ATT")&&Mj.dispose();for(var a=0,b=Gj.length;a<b;a++)Vf(Gj[a]);Gj.length=0;Ej("//static.doubleclick.net/instream/ad_status.js");Hj=!1;O("DCLKSTAT",0);Qc(im,hm);Z&&(Z.removeEventListener("onVideoDataChange",jm),Z.destroy())});
window.addEventListener?(window.addEventListener("load",lm),window.addEventListener("unload",mm)):window.attachEvent&&(window.attachEvent("onload",lm),window.attachEvent("onunload",mm));Ta("yt.abuse.player.botguardInitialized",y("yt.abuse.player.botguardInitialized")||Nj);Ta("yt.abuse.player.invokeBotguard",y("yt.abuse.player.invokeBotguard")||Oj);Ta("yt.abuse.dclkstatus.checkDclkStatus",y("yt.abuse.dclkstatus.checkDclkStatus")||Jj);
Ta("yt.player.exports.navigate",y("yt.player.exports.navigate")||km);Ta("yt.util.activity.init",y("yt.util.activity.init")||Xf);Ta("yt.util.activity.getTimeSinceActive",y("yt.util.activity.getTimeSinceActive")||$f);Ta("yt.util.activity.setTimestamp",y("yt.util.activity.setTimestamp")||Yf);}).call(this);
